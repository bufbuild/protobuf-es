...
void suite("GeneratedFile.preamble", () => {
  ...
  void test("elides plugin version with elide_plugin_version=true", async () => {
    const lines = await testGenerate({
      parameter: "elide_plugin_version=true",
      proto: `syntax="proto3";`,
      name: "pi-plugin",
      version: "v3.14159",
    });
    assert.ok(
      lines.includes(
        `// @generated by pi-plugin with parameter "elide_plugin_version=true"`,
      ),
    );
  });
