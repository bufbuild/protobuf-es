  ...
  describe("file preamble", () => {
    ...
    test("strips all rewrite_imports if present", () => {
      const linesOf = transpile((schema) => {
        ...
        f.preamble(fileObj);
        f.print("export const t = 1;");
      }, "target=ts+js+dts,rewrite_imports=./test/*_pb.js:@buf/test,rewrite_imports=./test/*_web.js:@buf/web,keep_empty_files=true");

      expect(linesOf("test.ts")).toStrictEqual([
        '// @generated by test-plugin v99.0.0 with parameter "target=ts+js+dts,keep_empty_files=true"',
        "// @generated from file test.proto (syntax proto3)",
        "/* eslint-disable */",
        "// @ts-nocheck",
        "",
