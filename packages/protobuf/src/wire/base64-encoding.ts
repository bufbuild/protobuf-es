...
let encodeTableStd: string[] | undefined;
let encodeTableUrl: string[] | undefined;

// lookup table from base64 character *code* to byte because lookup by number is fast
let decodeTable: Record<number, number> | undefined;

function getEncodeTable(encoding: "std" | "std_raw" | "url"): string[] {
  if (!encodeTableStd) {
    encodeTableStd =
