...
// @generated by protoc-gen-es v0.100.0 with parameter "bootstrap_wkt=true,target=ts,import_extension=js,json_types=true"
 ...
 */
export const DoubleValueSchema: GenMessage<DoubleValue, {jsonType: DoubleValueJson}> = /*@__PURE__*/
 ...
 */
export const FloatValueSchema: GenMessage<FloatValue, {jsonType: FloatValueJson}> = /*@__PURE__*/
 ...
 */
export const Int64ValueSchema: GenMessage<Int64Value, {jsonType: Int64ValueJson}> = /*@__PURE__*/
 ...
 */
export const UInt64ValueSchema: GenMessage<UInt64Value, {jsonType: UInt64ValueJson}> = /*@__PURE__*/
 ...
 */
export const Int32ValueSchema: GenMessage<Int32Value, {jsonType: Int32ValueJson}> = /*@__PURE__*/
 ...
 */
export const UInt32ValueSchema: GenMessage<UInt32Value, {jsonType: UInt32ValueJson}> = /*@__PURE__*/
 ...
 */
export const BoolValueSchema: GenMessage<BoolValue, {jsonType: BoolValueJson}> = /*@__PURE__*/
 ...
 */
export const StringValueSchema: GenMessage<StringValue, {jsonType: StringValueJson}> = /*@__PURE__*/
 ...
 */
export const BytesValueSchema: GenMessage<BytesValue, {jsonType: BytesValueJson}> = /*@__PURE__*/
