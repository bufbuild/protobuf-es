...
// @generated by protoc-gen-es v2.3.0 with parameter "bootstrap_wkt=true,target=ts,import_extension=js,json_types=true"
 ...
 */
export const JavaFeaturesSchema: GenMessage<JavaFeatures, JavaFeaturesJson> = /*@__PURE__*/
