...
// Use `create(TestAllTypesEdition2023Desc)` to create a new TestAllTypesEdition2023.
...
// Use `create(TestAllTypesEdition2023_NestedMessageDesc)` to create a new TestAllTypesEdition2023_NestedMessage.
...
// Use `create(TestAllTypesEdition2023_GroupLikeTypeDesc)` to create a new TestAllTypesEdition2023_GroupLikeType.
...
// Use `create(ForeignMessageEdition2023Desc)` to create a new ForeignMessageEdition2023.
...
// Use `create(GroupLikeTypeDesc)` to create a new GroupLikeType.
