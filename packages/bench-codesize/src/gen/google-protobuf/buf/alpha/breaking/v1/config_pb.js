...
proto.buf.alpha.breaking.v1.Config = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.buf.alpha.breaking.v1.Config.repeatedFields_,
    null
  );
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.buf.alpha.breaking.v1.Config.displayName =
    "proto.buf.alpha.breaking.v1.Config";
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.buf.alpha.breaking.v1.IDPaths = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.buf.alpha.breaking.v1.IDPaths.repeatedFields_,
    null
  );
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.buf.alpha.breaking.v1.IDPaths.displayName =
    "proto.buf.alpha.breaking.v1.IDPaths";
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.buf.alpha.breaking.v1.Config.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.buf.alpha.breaking.v1.Config.toObject(
      opt_includeInstance,
      this
    );
  };
   ...
   */
  proto.buf.alpha.breaking.v1.Config.toObject = function (
    includeInstance,
    msg
  ) {
    var f,
      obj = {
        ...
        ignoreIdPathsList: jspb.Message.toObjectList(
          msg.getIgnoreIdPathsList(),
          proto.buf.alpha.breaking.v1.IDPaths.toObject,
          includeInstance
        ),
        ignoreUnstablePackages: jspb.Message.getBooleanFieldWithDefault(
          msg,
          6,
          false
        ),
...
proto.buf.alpha.breaking.v1.Config.deserializeBinary = function (bytes) {
  ...
  return proto.buf.alpha.breaking.v1.Config.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.buf.alpha.breaking.v1.Config}
 */
proto.buf.alpha.breaking.v1.Config.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 5:
        ...
        reader.readMessage(
          value,
          proto.buf.alpha.breaking.v1.IDPaths.deserializeBinaryFromReader
        );
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.buf.alpha.breaking.v1.Config.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
 ...
 * @return {!proto.buf.alpha.breaking.v1.Config} returns this
 */
proto.buf.alpha.breaking.v1.Config.prototype.addUseIds = function (
  value,
  opt_index
) {
 ...
 * @return {!proto.buf.alpha.breaking.v1.Config} returns this
 */
proto.buf.alpha.breaking.v1.Config.prototype.setExceptIdsList = function (
  value
) {
 ...
 * @return {!proto.buf.alpha.breaking.v1.Config} returns this
 */
proto.buf.alpha.breaking.v1.Config.prototype.addExceptIds = function (
  value,
  opt_index
) {
 ...
 * @return {!proto.buf.alpha.breaking.v1.Config} returns this
 */
proto.buf.alpha.breaking.v1.Config.prototype.setIgnorePathsList = function (
  value
) {
 ...
 * @return {!proto.buf.alpha.breaking.v1.Config} returns this
 */
proto.buf.alpha.breaking.v1.Config.prototype.addIgnorePaths = function (
  value,
  opt_index
) {
 ...
 * @return {!proto.buf.alpha.breaking.v1.Config} returns this
 */
proto.buf.alpha.breaking.v1.Config.prototype.clearIgnorePathsList =
  function () {
 ...
 */
proto.buf.alpha.breaking.v1.Config.prototype.getIgnoreIdPathsList =
  function () {
 ...
 * @return {!proto.buf.alpha.breaking.v1.Config} returns this
 */
proto.buf.alpha.breaking.v1.Config.prototype.setIgnoreIdPathsList = function (
  value
) {
 ...
 */
proto.buf.alpha.breaking.v1.Config.prototype.addIgnoreIdPaths = function (
  opt_value,
  opt_index
) {
 ...
 * @return {!proto.buf.alpha.breaking.v1.Config} returns this
 */
proto.buf.alpha.breaking.v1.Config.prototype.clearIgnoreIdPathsList =
  function () {
 ...
 * @return {boolean}
 */
proto.buf.alpha.breaking.v1.Config.prototype.getIgnoreUnstablePackages =
  function () {
    return /** @type {boolean} */ (
 ...
 * @return {!proto.buf.alpha.breaking.v1.Config} returns this
 */
proto.buf.alpha.breaking.v1.Config.prototype.setIgnoreUnstablePackages =
  function (value) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.buf.alpha.breaking.v1.IDPaths.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.buf.alpha.breaking.v1.IDPaths.toObject(
      opt_includeInstance,
      this
    );
  };
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.buf.alpha.breaking.v1.IDPaths.toObject = function (
    includeInstance,
    msg
  ) {
    var f,
...
proto.buf.alpha.breaking.v1.IDPaths.deserializeBinary = function (bytes) {
  ...
  return proto.buf.alpha.breaking.v1.IDPaths.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.buf.alpha.breaking.v1.IDPaths}
 */
proto.buf.alpha.breaking.v1.IDPaths.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.buf.alpha.breaking.v1.IDPaths.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
 ...
 * @return {!proto.buf.alpha.breaking.v1.IDPaths} returns this
 */
proto.buf.alpha.breaking.v1.IDPaths.prototype.addPaths = function (
  value,
  opt_index
) {
  return jspb.Message.addToRepeatedField(this, 2, value, opt_index);
