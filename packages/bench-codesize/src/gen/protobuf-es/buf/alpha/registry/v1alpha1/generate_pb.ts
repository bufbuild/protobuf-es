...
export class RuntimeLibrary extends Message<RuntimeLibrary> {
  ...
  static equals(
    a: RuntimeLibrary | PlainMessage<RuntimeLibrary> | undefined,
    b: RuntimeLibrary | PlainMessage<RuntimeLibrary> | undefined
  ): boolean {
...
export class PluginReference extends Message<PluginReference> {
  ...
  static equals(
    a: PluginReference | PlainMessage<PluginReference> | undefined,
    b: PluginReference | PlainMessage<PluginReference> | undefined
  ): boolean {
...
export class GeneratePluginsRequest extends Message<GeneratePluginsRequest> {
  ...
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.GeneratePluginsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static equals(
    a:
      | GeneratePluginsRequest
      | PlainMessage<GeneratePluginsRequest>
      | undefined,
    b: GeneratePluginsRequest | PlainMessage<GeneratePluginsRequest> | undefined
  ): boolean {
...
export class GeneratePluginsResponse extends Message<GeneratePluginsResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.GeneratePluginsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    {
      no: 1,
      name: "responses",
      kind: "message",
      T: CodeGeneratorResponse,
      repeated: true,
    },
    {
      no: 2,
  ...
  static equals(
    a:
      | GeneratePluginsResponse
      | PlainMessage<GeneratePluginsResponse>
      | undefined,
    b:
      | GeneratePluginsResponse
      | PlainMessage<GeneratePluginsResponse>
...
export class GenerateTemplateRequest extends Message<GenerateTemplateRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.GenerateTemplateRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "image", kind: "message", T: Image },
    {
      no: 2,
  ...
  static equals(
    a:
      | GenerateTemplateRequest
      | PlainMessage<GenerateTemplateRequest>
      | undefined,
    b:
      | GenerateTemplateRequest
      | PlainMessage<GenerateTemplateRequest>
...
export class GenerateTemplateResponse extends Message<GenerateTemplateResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.GenerateTemplateResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static equals(
    a:
      | GenerateTemplateResponse
      | PlainMessage<GenerateTemplateResponse>
      | undefined,
    b:
      | GenerateTemplateResponse
      | PlainMessage<GenerateTemplateResponse>
