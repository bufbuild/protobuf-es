...
export class GetImageRequest extends Message<GetImageRequest> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    {
      no: 4,
      name: "exclude_imports",
      kind: "scalar",
      T: 8 /* ScalarType.BOOL */,
    },
    {
      no: 5,
      name: "exclude_source_info",
      kind: "scalar",
      T: 8 /* ScalarType.BOOL */,
    },
    {
    ...
    },
    {
      ...
      name: "include_mask",
      kind: "enum",
      T: proto3.getEnumType(ImageMask),
      repeated: true,
    },
  ]);
  ...
  static equals(
    a: GetImageRequest | PlainMessage<GetImageRequest> | undefined,
    b: GetImageRequest | PlainMessage<GetImageRequest> | undefined
  ): boolean {
...
export class GetImageResponse extends Message<GetImageResponse> {
  ...
  static equals(
    a: GetImageResponse | PlainMessage<GetImageResponse> | undefined,
    b: GetImageResponse | PlainMessage<GetImageResponse> | undefined
  ): boolean {
