...
proto3.util.setEnumType(
  ...
  "buf.alpha.registry.v1alpha1.ResolvedReferenceType",
  [
...
export class GetModulePinsRequest extends Message<GetModulePinsRequest> {
  ...
  static equals(
    a: GetModulePinsRequest | PlainMessage<GetModulePinsRequest> | undefined,
    b: GetModulePinsRequest | PlainMessage<GetModulePinsRequest> | undefined
  ): boolean {
...
export class GetModulePinsResponse extends Message<GetModulePinsResponse> {
  ...
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.GetModulePinsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    {
      no: 1,
      name: "module_pins",
  ...
  static equals(
    a: GetModulePinsResponse | PlainMessage<GetModulePinsResponse> | undefined,
    b: GetModulePinsResponse | PlainMessage<GetModulePinsResponse> | undefined
  ): boolean {
...
export class GetLocalModulePinsRequest extends Message<GetLocalModulePinsRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.GetLocalModulePinsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    {
      no: 1,
      name: "local_module_references",
      kind: "message",
      T: LocalModuleReference,
      repeated: true,
    },
  ]);
  ...
  static equals(
    a:
      | GetLocalModulePinsRequest
      | PlainMessage<GetLocalModulePinsRequest>
      | undefined,
    b:
      | GetLocalModulePinsRequest
      | PlainMessage<GetLocalModulePinsRequest>
...
export class LocalModuleResolveResult extends Message<LocalModuleResolveResult> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "pin", kind: "message", T: LocalModulePin },
    {
      ...
      kind: "enum",
      T: proto3.getEnumType(ResolvedReferenceType),
    },
  ]);
  ...
  static equals(
    a:
      | LocalModuleResolveResult
      | PlainMessage<LocalModuleResolveResult>
      | undefined,
    b:
      | LocalModuleResolveResult
      | PlainMessage<LocalModuleResolveResult>
...
export class GetLocalModulePinsResponse extends Message<GetLocalModulePinsResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.GetLocalModulePinsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    {
      no: 1,
      name: "local_module_resolve_results",
      kind: "message",
      T: LocalModuleResolveResult,
      repeated: true,
    },
    {
      no: 2,
  ...
  static equals(
    a:
      | GetLocalModulePinsResponse
      | PlainMessage<GetLocalModulePinsResponse>
      | undefined,
    b:
      | GetLocalModulePinsResponse
      | PlainMessage<GetLocalModulePinsResponse>
