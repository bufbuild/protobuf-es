...
export class GetJSONSchemaRequest extends Message<GetJSONSchemaRequest> {
  ...
  static equals(
    a: GetJSONSchemaRequest | PlainMessage<GetJSONSchemaRequest> | undefined,
    b: GetJSONSchemaRequest | PlainMessage<GetJSONSchemaRequest> | undefined
  ): boolean {
...
export class GetJSONSchemaResponse extends Message<GetJSONSchemaResponse> {
  ...
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.GetJSONSchemaResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    {
      no: 1,
      name: "json_schema",
  ...
  static equals(
    a: GetJSONSchemaResponse | PlainMessage<GetJSONSchemaResponse> | undefined,
    b: GetJSONSchemaResponse | PlainMessage<GetJSONSchemaResponse> | undefined
  ): boolean {
