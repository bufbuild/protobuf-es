...
export class RepositoryTag extends Message<RepositoryTag> {
  ...
  static equals(
    a: RepositoryTag | PlainMessage<RepositoryTag> | undefined,
    b: RepositoryTag | PlainMessage<RepositoryTag> | undefined
  ): boolean {
...
export class CreateRepositoryTagRequest extends Message<CreateRepositoryTagRequest> {
  ...
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.CreateRepositoryTagRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    {
      no: 1,
      name: "repository_id",
  ...
  static equals(
    a:
      | CreateRepositoryTagRequest
      | PlainMessage<CreateRepositoryTagRequest>
      | undefined,
    b:
      | CreateRepositoryTagRequest
      | PlainMessage<CreateRepositoryTagRequest>
...
export class CreateRepositoryTagResponse extends Message<CreateRepositoryTagResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.CreateRepositoryTagResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromJsonString(
    ...
    return new CreateRepositoryTagResponse().fromJsonString(
      jsonString,
      options
    );
  }
  ...
  static equals(
    a:
      | CreateRepositoryTagResponse
      | PlainMessage<CreateRepositoryTagResponse>
      | undefined,
    b:
      | CreateRepositoryTagResponse
      | PlainMessage<CreateRepositoryTagResponse>
...
export class ListRepositoryTagsRequest extends Message<ListRepositoryTagsRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.ListRepositoryTagsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    {
      no: 1,
      name: "repository_id",
  ...
  static equals(
    a:
      | ListRepositoryTagsRequest
      | PlainMessage<ListRepositoryTagsRequest>
      | undefined,
    b:
      | ListRepositoryTagsRequest
      | PlainMessage<ListRepositoryTagsRequest>
...
export class ListRepositoryTagsResponse extends Message<ListRepositoryTagsResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.ListRepositoryTagsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    {
      no: 1,
  ...
  static equals(
    a:
      | ListRepositoryTagsResponse
      | PlainMessage<ListRepositoryTagsResponse>
      | undefined,
    b:
      | ListRepositoryTagsResponse
      | PlainMessage<ListRepositoryTagsResponse>
