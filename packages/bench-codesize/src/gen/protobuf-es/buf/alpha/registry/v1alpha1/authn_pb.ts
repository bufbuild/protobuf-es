...
export class GetCurrentUserRequest extends Message<GetCurrentUserRequest> {
  ...
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.GetCurrentUserRequest";
...
export class GetCurrentUserResponse extends Message<GetCurrentUserResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.GetCurrentUserResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class GetCurrentUserSubjectRequest extends Message<GetCurrentUserSubjectRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.GetCurrentUserSubjectRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => []);
  ...
  static fromJsonString(
    ...
    return new GetCurrentUserSubjectRequest().fromJsonString(
      jsonString,
      options
    );
  }
  ...
  static equals(
    a:
      | GetCurrentUserSubjectRequest
      | PlainMessage<GetCurrentUserSubjectRequest>
      | undefined,
    b:
      | GetCurrentUserSubjectRequest
      | PlainMessage<GetCurrentUserSubjectRequest>
...
export class GetCurrentUserSubjectResponse extends Message<GetCurrentUserSubjectResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.GetCurrentUserSubjectResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromJsonString(
    ...
    return new GetCurrentUserSubjectResponse().fromJsonString(
      jsonString,
      options
    );
  }
  ...
  static equals(
    a:
      | GetCurrentUserSubjectResponse
      | PlainMessage<GetCurrentUserSubjectResponse>
      | undefined,
    b:
      | GetCurrentUserSubjectResponse
      | PlainMessage<GetCurrentUserSubjectResponse>
