...
proto3.util.setEnumType(
  SearchFilter,
  "buf.alpha.registry.v1alpha1.SearchFilter",
  [
...
export class RepositorySearchResult extends Message<RepositorySearchResult> {
  ...
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.RepositorySearchResult";
  ...
  static equals(
    a:
      | RepositorySearchResult
      | PlainMessage<RepositorySearchResult>
      | undefined,
    b: RepositorySearchResult | PlainMessage<RepositorySearchResult> | undefined
  ): boolean {
...
export class OrganizationSearchResult extends Message<OrganizationSearchResult> {
  ...
  static readonly runtime = proto3;
  static readonly typeName =
    "buf.alpha.registry.v1alpha1.OrganizationSearchResult";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
  ...
  static equals(
    a:
      | OrganizationSearchResult
      | PlainMessage<OrganizationSearchResult>
      | undefined,
    b:
      | OrganizationSearchResult
      | PlainMessage<OrganizationSearchResult>
...
export class UserSearchResult extends Message<UserSearchResult> {
  ...
  static equals(
    a: UserSearchResult | PlainMessage<UserSearchResult> | undefined,
    b: UserSearchResult | PlainMessage<UserSearchResult> | undefined
  ): boolean {
...
export class TeamSearchResult extends Message<TeamSearchResult> {
  ...
  static equals(
    a: TeamSearchResult | PlainMessage<TeamSearchResult> | undefined,
    b: TeamSearchResult | PlainMessage<TeamSearchResult> | undefined
  ): boolean {
...
export class PluginSearchResult extends Message<PluginSearchResult> {
  ...
  static equals(
    a: PluginSearchResult | PlainMessage<PluginSearchResult> | undefined,
    b: PluginSearchResult | PlainMessage<PluginSearchResult> | undefined
  ): boolean {
...
export class TemplateSearchResult extends Message<TemplateSearchResult> {
  ...
  static equals(
    a: TemplateSearchResult | PlainMessage<TemplateSearchResult> | undefined,
    b: TemplateSearchResult | PlainMessage<TemplateSearchResult> | undefined
  ): boolean {
...
export class SearchRequest extends Message<SearchRequest> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    },
    {
      ...
      name: "filters",
      kind: "enum",
      T: proto3.getEnumType(SearchFilter),
      repeated: true,
    },
  ]);
  ...
  static equals(
    a: SearchRequest | PlainMessage<SearchRequest> | undefined,
    b: SearchRequest | PlainMessage<SearchRequest> | undefined
  ): boolean {
...
export class SearchResponse extends Message<SearchResponse> {
  ...
  static equals(
    a: SearchResponse | PlainMessage<SearchResponse> | undefined,
    b: SearchResponse | PlainMessage<SearchResponse> | undefined
  ): boolean {
