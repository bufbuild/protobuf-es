...
proto3.util.setEnumType(
  ...
  "buf.alpha.audit.v1alpha1.BufAlphaRegistryV1Alpha1PluginVisibility",
  [
    {
      no: 0,
      name: "BUF_ALPHA_REGISTRY_V1_ALPHA1_PLUGIN_VISIBILITY_UNSPECIFIED",
    },
...
export class BufAlphaRegistryV1Alpha1PluginVersionMapping extends Message<BufAlphaRegistryV1Alpha1PluginVersionMapping> {
  ...
  constructor(
    data?: PartialMessage<BufAlphaRegistryV1Alpha1PluginVersionMapping>
  ) {
    super();
  ...
  static readonly typeName =
    "buf.alpha.audit.v1alpha1.BufAlphaRegistryV1Alpha1PluginVersionMapping";
  ...
  static fromBinary(
    ...
    return new BufAlphaRegistryV1Alpha1PluginVersionMapping().fromBinary(
      bytes,
      options
    );
  }
  ...
  static fromJson(
    ...
    return new BufAlphaRegistryV1Alpha1PluginVersionMapping().fromJson(
      jsonValue,
      options
    );
  }
  ...
  static fromJsonString(
    ...
    return new BufAlphaRegistryV1Alpha1PluginVersionMapping().fromJsonString(
      jsonString,
      options
    );
  }
  ...
  static equals(
    a:
      | BufAlphaRegistryV1Alpha1PluginVersionMapping
      | PlainMessage<BufAlphaRegistryV1Alpha1PluginVersionMapping>
      | undefined,
    b:
      | BufAlphaRegistryV1Alpha1PluginVersionMapping
      | PlainMessage<BufAlphaRegistryV1Alpha1PluginVersionMapping>
...
export class BufAlphaRegistryV1Alpha1PluginConfig extends Message<BufAlphaRegistryV1Alpha1PluginConfig> {
  ...
  static readonly runtime = proto3;
  static readonly typeName =
    "buf.alpha.audit.v1alpha1.BufAlphaRegistryV1Alpha1PluginConfig";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    {
      no: 1,
      name: "plugin_owner",
  ...
  static fromBinary(
    ...
    return new BufAlphaRegistryV1Alpha1PluginConfig().fromBinary(
      bytes,
      options
    );
  }
  ...
  static fromJson(
    ...
    return new BufAlphaRegistryV1Alpha1PluginConfig().fromJson(
      jsonValue,
      options
    );
  }
  ...
  static fromJsonString(
    ...
    return new BufAlphaRegistryV1Alpha1PluginConfig().fromJsonString(
      jsonString,
      options
    );
  }
  ...
  static equals(
    a:
      | BufAlphaRegistryV1Alpha1PluginConfig
      | PlainMessage<BufAlphaRegistryV1Alpha1PluginConfig>
      | undefined,
    b:
      | BufAlphaRegistryV1Alpha1PluginConfig
      | PlainMessage<BufAlphaRegistryV1Alpha1PluginConfig>
...
export class BufAlphaRegistryV1Alpha1PluginVersionRuntimeLibrary extends Message<BufAlphaRegistryV1Alpha1PluginVersionRuntimeLibrary> {
  ...
  constructor(
    data?: PartialMessage<BufAlphaRegistryV1Alpha1PluginVersionRuntimeLibrary>
  ) {
    super();
    proto3.util.initPartial(data, this);
  }
  ...
  static readonly runtime = proto3;
  static readonly typeName =
    "buf.alpha.audit.v1alpha1.BufAlphaRegistryV1Alpha1PluginVersionRuntimeLibrary";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromBinary(
    ...
    return new BufAlphaRegistryV1Alpha1PluginVersionRuntimeLibrary().fromBinary(
      bytes,
      options
    );
  }
  ...
  static fromJson(
    ...
    return new BufAlphaRegistryV1Alpha1PluginVersionRuntimeLibrary().fromJson(
      jsonValue,
      options
    );
  }
  ...
  static fromJsonString(
    ...
    return new BufAlphaRegistryV1Alpha1PluginVersionRuntimeLibrary().fromJsonString(
      jsonString,
      options
    );
  }
  ...
  static equals(
    a:
      | BufAlphaRegistryV1Alpha1PluginVersionRuntimeLibrary
      | PlainMessage<BufAlphaRegistryV1Alpha1PluginVersionRuntimeLibrary>
      | undefined,
    b:
      | BufAlphaRegistryV1Alpha1PluginVersionRuntimeLibrary
      | PlainMessage<BufAlphaRegistryV1Alpha1PluginVersionRuntimeLibrary>
