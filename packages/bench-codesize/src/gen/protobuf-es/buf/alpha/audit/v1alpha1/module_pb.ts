...
proto3.util.setEnumType(
  ...
  "buf.alpha.audit.v1alpha1.BufAlphaRegistryV1Alpha1ResolvedReferenceType",
  [
    {
      no: 0,
      name: "BUF_ALPHA_REGISTRY_V1_ALPHA1_RESOLVED_REFERENCE_TYPE_UNSPECIFIED",
    },
    {
      no: 1,
      name: "BUF_ALPHA_REGISTRY_V1_ALPHA1_RESOLVED_REFERENCE_TYPE_COMMIT",
    },
    {
      no: 2,
      name: "BUF_ALPHA_REGISTRY_V1_ALPHA1_RESOLVED_REFERENCE_TYPE_BRANCH",
    },
    { no: 3, name: "BUF_ALPHA_REGISTRY_V1_ALPHA1_RESOLVED_REFERENCE_TYPE_TAG" },
    {
      no: 4,
      name: "BUF_ALPHA_REGISTRY_V1_ALPHA1_RESOLVED_REFERENCE_TYPE_TRACK",
    },
  ]
);
...
export class BufAlphaRegistryV1Alpha1LocalModulePin extends Message<BufAlphaRegistryV1Alpha1LocalModulePin> {
  ...
  static readonly typeName =
    "buf.alpha.audit.v1alpha1.BufAlphaRegistryV1Alpha1LocalModulePin";
  ...
  static fromBinary(
    ...
    return new BufAlphaRegistryV1Alpha1LocalModulePin().fromBinary(
      bytes,
      options
    );
  }
  ...
  static fromJson(
    ...
    return new BufAlphaRegistryV1Alpha1LocalModulePin().fromJson(
      jsonValue,
      options
    );
  }
  ...
  static fromJsonString(
    ...
    return new BufAlphaRegistryV1Alpha1LocalModulePin().fromJsonString(
      jsonString,
      options
    );
  }
  ...
  static equals(
    a:
      | BufAlphaRegistryV1Alpha1LocalModulePin
      | PlainMessage<BufAlphaRegistryV1Alpha1LocalModulePin>
      | undefined,
    b:
      | BufAlphaRegistryV1Alpha1LocalModulePin
      | PlainMessage<BufAlphaRegistryV1Alpha1LocalModulePin>
...
export class BufAlphaRegistryV1Alpha1LocalModuleReference extends Message<BufAlphaRegistryV1Alpha1LocalModuleReference> {
  ...
  constructor(
    data?: PartialMessage<BufAlphaRegistryV1Alpha1LocalModuleReference>
  ) {
    super();
    proto3.util.initPartial(data, this);
  }
  ...
  static readonly runtime = proto3;
  static readonly typeName =
    "buf.alpha.audit.v1alpha1.BufAlphaRegistryV1Alpha1LocalModuleReference";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "owner", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "repository", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ...
  static fromBinary(
    ...
    return new BufAlphaRegistryV1Alpha1LocalModuleReference().fromBinary(
      bytes,
      options
    );
  }
  ...
  static fromJson(
    ...
    return new BufAlphaRegistryV1Alpha1LocalModuleReference().fromJson(
      jsonValue,
      options
    );
  }
  ...
  static fromJsonString(
    ...
    return new BufAlphaRegistryV1Alpha1LocalModuleReference().fromJsonString(
      jsonString,
      options
    );
  }
  ...
  static equals(
    a:
      | BufAlphaRegistryV1Alpha1LocalModuleReference
      | PlainMessage<BufAlphaRegistryV1Alpha1LocalModuleReference>
      | undefined,
    b:
      | BufAlphaRegistryV1Alpha1LocalModuleReference
      | PlainMessage<BufAlphaRegistryV1Alpha1LocalModuleReference>
...
export class BufAlphaRegistryV1Alpha1LocalModuleResolveResult extends Message<BufAlphaRegistryV1Alpha1LocalModuleResolveResult> {
  ...
  resolvedReferenceType =
    BufAlphaRegistryV1Alpha1ResolvedReferenceType.BUF_ALPHA_REGISTRY_V1_ALPHA1_RESOLVED_REFERENCE_TYPE_UNSPECIFIED;

  constructor(
    data?: PartialMessage<BufAlphaRegistryV1Alpha1LocalModuleResolveResult>
  ) {
    super();
    proto3.util.initPartial(data, this);
  }
  ...
  static readonly runtime = proto3;
  static readonly typeName =
    "buf.alpha.audit.v1alpha1.BufAlphaRegistryV1Alpha1LocalModuleResolveResult";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    {
      no: 1,
      name: "reference",
    ...
    },
    {
      ...
      name: "pin",
      kind: "message",
      T: BufAlphaRegistryV1Alpha1LocalModulePin,
    },
    {
      no: 3,
      name: "resolved_reference_type",
      kind: "enum",
      T: proto3.getEnumType(BufAlphaRegistryV1Alpha1ResolvedReferenceType),
    },
  ]);
  ...
  static fromBinary(
    ...
    return new BufAlphaRegistryV1Alpha1LocalModuleResolveResult().fromBinary(
      bytes,
      options
    );
  }
  ...
  static fromJson(
    ...
    return new BufAlphaRegistryV1Alpha1LocalModuleResolveResult().fromJson(
      jsonValue,
      options
    );
  }
  ...
  static fromJsonString(
    ...
    return new BufAlphaRegistryV1Alpha1LocalModuleResolveResult().fromJsonString(
      jsonString,
      options
    );
  }
  ...
  static equals(
    a:
      | BufAlphaRegistryV1Alpha1LocalModuleResolveResult
      | PlainMessage<BufAlphaRegistryV1Alpha1LocalModuleResolveResult>
      | undefined,
    b:
      | BufAlphaRegistryV1Alpha1LocalModuleResolveResult
      | PlainMessage<BufAlphaRegistryV1Alpha1LocalModuleResolveResult>
