 ...
 */
export const VisibilitySchema: GenDescMessage<Visibility, VisibilityJson> = /*@__PURE__*/
 ...
 */
export const VisibilityRuleSchema: GenDescMessage<VisibilityRule, VisibilityRuleJson> = /*@__PURE__*/
