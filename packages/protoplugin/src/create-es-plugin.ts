...
export function createEcmaScriptPlugin(init: PluginInit): Plugin {
  ...
  return {
    ...
    run(req) {
      ...
      // specified, we still may have generated them to assist in transpilation.  If they were generated but not
      // specified in the target out, we shouldn't produce these files in the CodeGeneratorResponse.
