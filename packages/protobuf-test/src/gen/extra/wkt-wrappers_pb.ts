...
export class WrappersMessage extends Message<WrappersMessage> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    {
      no: 21,
      name: "repeated_double_value_field",
      kind: "message",
      T: DoubleValue,
      repeated: true,
    },
    {
      no: 22,
      name: "repeated_bool_value_field",
      kind: "message",
      T: BoolValue,
      repeated: true,
    },
    {
      no: 23,
      name: "repeated_float_value_field",
      kind: "message",
      T: FloatValue,
      repeated: true,
    },
    {
      no: 24,
      name: "repeated_int64_value_field",
      kind: "message",
      T: Int64Value,
      repeated: true,
    },
    {
      no: 25,
      name: "repeated_uint64_value_field",
      kind: "message",
      T: UInt64Value,
      repeated: true,
    },
    {
      no: 26,
      name: "repeated_int32_value_field",
      kind: "message",
      T: Int32Value,
      repeated: true,
    },
    {
      no: 27,
      name: "repeated_uint32_value_field",
      kind: "message",
      T: UInt32Value,
      repeated: true,
    },
    {
      no: 28,
      name: "repeated_string_value_field",
      kind: "message",
      T: StringValue,
      repeated: true,
    },
    {
      no: 29,
      name: "repeated_bytes_value_field",
      kind: "message",
      T: BytesValue,
      repeated: true,
    },
  ...
  static equals(
    a: WrappersMessage | PlainMessage<WrappersMessage> | undefined,
    b: WrappersMessage | PlainMessage<WrappersMessage> | undefined
  ): boolean {
