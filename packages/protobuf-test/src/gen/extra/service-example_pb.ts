...
export class ExampleRequest extends Message<ExampleRequest> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "question", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    {
      ...
      name: "please_fail",
      kind: "enum",
      T: proto3.getEnumType(FailRequest),
    },
    {
      no: 3,
      name: "please_delay_response_ms",
      kind: "scalar",
      T: 5 /* ScalarType.INT32 */,
    },
    {
      no: 4,
      name: "disable_sending_example_response_headers",
      kind: "scalar",
      T: 8 /* ScalarType.BOOL */,
    },
  ]);
  ...
  static equals(
    a: ExampleRequest | PlainMessage<ExampleRequest> | undefined,
    b: ExampleRequest | PlainMessage<ExampleRequest> | undefined
  ): boolean {
...
export class ExampleResponse extends Message<ExampleResponse> {
  ...
  static equals(
    a: ExampleResponse | PlainMessage<ExampleResponse> | undefined,
    b: ExampleResponse | PlainMessage<ExampleResponse> | undefined
  ): boolean {
