...
export class ScalarValuesMessage extends Message<ScalarValuesMessage> {
  ...
  static equals(
    a: ScalarValuesMessage | PlainMessage<ScalarValuesMessage> | undefined,
    b: ScalarValuesMessage | PlainMessage<ScalarValuesMessage> | undefined
  ): boolean {
...
export class RepeatedScalarValuesMessage extends Message<RepeatedScalarValuesMessage> {
  ...
  static fromJsonString(
    ...
    return new RepeatedScalarValuesMessage().fromJsonString(
      jsonString,
      options
    );
  }
  ...
  static equals(
    a:
      | RepeatedScalarValuesMessage
      | PlainMessage<RepeatedScalarValuesMessage>
      | undefined,
    b:
      | RepeatedScalarValuesMessage
      | PlainMessage<RepeatedScalarValuesMessage>
