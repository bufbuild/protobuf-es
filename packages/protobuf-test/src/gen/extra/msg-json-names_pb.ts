...
export class JsonNamesMessage extends Message<JsonNamesMessage> {
  ...
  static equals(
    a: JsonNamesMessage | PlainMessage<JsonNamesMessage> | undefined,
    b: JsonNamesMessage | PlainMessage<JsonNamesMessage> | undefined
  ): boolean {
