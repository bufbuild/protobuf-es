...
export class MapsMessage extends Message<MapsMessage> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    },
    {
      ...
      kind: "map",
      K: 9 /* ScalarType.STRING */,
      V: { kind: "message", T: MapsMessage },
    },
    {
      no: 10,
      name: "int32_msg_field",
      kind: "map",
      K: 5 /* ScalarType.INT32 */,
      V: { kind: "message", T: MapsMessage },
    },
    ...
    },
    {
      ...
      kind: "map",
      K: 9 /* ScalarType.STRING */,
      V: { kind: "enum", T: proto3.getEnumType(MapsEnum) },
    },
    {
      no: 13,
      name: "int32_enu_field",
      kind: "map",
      K: 5 /* ScalarType.INT32 */,
      V: { kind: "enum", T: proto3.getEnumType(MapsEnum) },
    },
  ...
  static equals(
    a: MapsMessage | PlainMessage<MapsMessage> | undefined,
    b: MapsMessage | PlainMessage<MapsMessage> | undefined
  ): boolean {
