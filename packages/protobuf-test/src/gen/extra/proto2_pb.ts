...
export class Proto2PackedMessage extends Message<Proto2PackedMessage> {
  ...
  static equals(
    a: Proto2PackedMessage | PlainMessage<Proto2PackedMessage> | undefined,
    b: Proto2PackedMessage | PlainMessage<Proto2PackedMessage> | undefined
  ): boolean {
...
export class Proto2UnpackedMessage extends Message<Proto2UnpackedMessage> {
  ...
  static equals(
    a: Proto2UnpackedMessage | PlainMessage<Proto2UnpackedMessage> | undefined,
    b: Proto2UnpackedMessage | PlainMessage<Proto2UnpackedMessage> | undefined
  ): boolean {
...
export class Proto2UnspecifiedPackedMessage extends Message<Proto2UnspecifiedPackedMessage> {
  ...
  static fromJsonString(
    ...
    return new Proto2UnspecifiedPackedMessage().fromJsonString(
      jsonString,
      options
    );
  }
  ...
  static equals(
    a:
      | Proto2UnspecifiedPackedMessage
      | PlainMessage<Proto2UnspecifiedPackedMessage>
      | undefined,
    b:
      | Proto2UnspecifiedPackedMessage
      | PlainMessage<Proto2UnspecifiedPackedMessage>
...
export class Proto2OptionalMessage extends Message<Proto2OptionalMessage> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    },
    {
      ...
      name: "enum_field",
      kind: "enum",
      T: proto2.getEnumType(Proto2Enum),
      opt: true,
    },
    {
      no: 4,
  ...
  static equals(
    a: Proto2OptionalMessage | PlainMessage<Proto2OptionalMessage> | undefined,
    b: Proto2OptionalMessage | PlainMessage<Proto2OptionalMessage> | undefined
  ): boolean {
...
export class Proto2RequiredMessage extends Message<Proto2RequiredMessage> {
  ...
  static equals(
    a: Proto2RequiredMessage | PlainMessage<Proto2RequiredMessage> | undefined,
    b: Proto2RequiredMessage | PlainMessage<Proto2RequiredMessage> | undefined
  ): boolean {
...
export class Proto2RequiredDefaultsMessage extends Message<Proto2RequiredDefaultsMessage> {
  ...
  static fromJsonString(
    ...
    return new Proto2RequiredDefaultsMessage().fromJsonString(
      jsonString,
      options
    );
  }
  ...
  static equals(
    a:
      | Proto2RequiredDefaultsMessage
      | PlainMessage<Proto2RequiredDefaultsMessage>
      | undefined,
    b:
      | Proto2RequiredDefaultsMessage
      | PlainMessage<Proto2RequiredDefaultsMessage>
...
export class Proto2DefaultsMessage extends Message<Proto2DefaultsMessage> {
  ...
  static equals(
    a: Proto2DefaultsMessage | PlainMessage<Proto2DefaultsMessage> | undefined,
    b: Proto2DefaultsMessage | PlainMessage<Proto2DefaultsMessage> | undefined
  ): boolean {
...
export class Proto2ChildMessage extends Message<Proto2ChildMessage> {
  ...
  static equals(
    a: Proto2ChildMessage | PlainMessage<Proto2ChildMessage> | undefined,
    b: Proto2ChildMessage | PlainMessage<Proto2ChildMessage> | undefined
  ): boolean {
