...
export class Proto3PackedMessage extends Message<Proto3PackedMessage> {
  ...
  static equals(
    a: Proto3PackedMessage | PlainMessage<Proto3PackedMessage> | undefined,
    b: Proto3PackedMessage | PlainMessage<Proto3PackedMessage> | undefined
  ): boolean {
...
export class Proto3UnpackedMessage extends Message<Proto3UnpackedMessage> {
  ...
  static equals(
    a: Proto3UnpackedMessage | PlainMessage<Proto3UnpackedMessage> | undefined,
    b: Proto3UnpackedMessage | PlainMessage<Proto3UnpackedMessage> | undefined
  ): boolean {
...
export class Proto3UnlabelledMessage extends Message<Proto3UnlabelledMessage> {
  ...
  static equals(
    a:
      | Proto3UnlabelledMessage
      | PlainMessage<Proto3UnlabelledMessage>
      | undefined,
    b:
      | Proto3UnlabelledMessage
      | PlainMessage<Proto3UnlabelledMessage>
...
export class Proto3OptionalMessage extends Message<Proto3OptionalMessage> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    },
    {
      ...
      name: "enum_field",
      kind: "enum",
      T: proto3.getEnumType(Proto3Enum),
      opt: true,
    },
    {
      no: 4,
  ...
  static equals(
    a: Proto3OptionalMessage | PlainMessage<Proto3OptionalMessage> | undefined,
    b: Proto3OptionalMessage | PlainMessage<Proto3OptionalMessage> | undefined
  ): boolean {
