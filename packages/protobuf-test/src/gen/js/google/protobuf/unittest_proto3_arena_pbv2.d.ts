 ...
 */
export declare type TestAllTypes = Message<"proto3_arena_unittest.TestAllTypes"> & {
  /**
   * Singular
   *
 ...
 */
export declare type TestAllTypes_NestedMessage = Message<"proto3_arena_unittest.TestAllTypes.NestedMessage"> & {
  /**
 ...
 */
export declare type TestPackedTypes = Message<"proto3_arena_unittest.TestPackedTypes"> & {
  /**
 ...
 */
export declare type TestUnpackedTypes = Message<"proto3_arena_unittest.TestUnpackedTypes"> & {
  /**
 ...
 */
export declare type NestedTestAllTypes = Message<"proto3_arena_unittest.NestedTestAllTypes"> & {
  /**
 ...
 */
export declare type ForeignMessage = Message<"proto3_arena_unittest.ForeignMessage"> & {
  /**
 ...
 */
export declare type TestPickleNestedMessage = Message<"proto3_arena_unittest.TestPickleNestedMessage"> & {
};
 ...
 */
export declare type TestPickleNestedMessage_NestedMessage = Message<"proto3_arena_unittest.TestPickleNestedMessage.NestedMessage"> & {
  /**
   * @generated from field: int32 bb = 1;
   */
  bb: number;
 ...
 */
export declare type TestPickleNestedMessage_NestedMessage_NestedNestedMessage = Message<"proto3_arena_unittest.TestPickleNestedMessage.NestedMessage.NestedNestedMessage"> & {
  /**
