 ...
 */
export declare const file_google_protobuf_test_messages_proto3: GenDescFile;
 ...
 */
export declare type TestAllTypesProto3 = Message<"protobuf_test_messages.proto3.TestAllTypesProto3"> & {
  /**
   * Singular
   *
...
/**
 * JSON type for the message protobuf_test_messages.proto3.TestAllTypesProto3.
 */
export declare type TestAllTypesProto3Json = {
  /**
   * @generated from field: int32 optional_int32 = 1;
   */
  optionalInt32?: number;
 ...
 */
export declare const TestAllTypesProto3Schema: GenDescMessage<TestAllTypesProto3, TestAllTypesProto3Json>;

/**
 * @generated from message protobuf_test_messages.proto3.TestAllTypesProto3.NestedMessage
 */
export declare type TestAllTypesProto3_NestedMessage = Message<"protobuf_test_messages.proto3.TestAllTypesProto3.NestedMessage"> & {
  /**
...
/**
 * JSON type for the message protobuf_test_messages.proto3.TestAllTypesProto3.NestedMessage.
 */
export declare type TestAllTypesProto3_NestedMessageJson = {
  /**
   * @generated from field: int32 a = 1;
   */
  a?: number;
 ...
 */
export declare const TestAllTypesProto3_NestedMessageSchema: GenDescMessage<TestAllTypesProto3_NestedMessage, TestAllTypesProto3_NestedMessageJson>;
...
/**
 * JSON type for the enum protobuf_test_messages.proto3.TestAllTypesProto3.NestedEnum.
 */
export declare type TestAllTypesProto3_NestedEnumJson = "FOO" | "BAR" | "BAZ" | "NEG";

/**
 * Describes the enum protobuf_test_messages.proto3.TestAllTypesProto3.NestedEnum.
 */
export declare const TestAllTypesProto3_NestedEnumSchema: GenDescEnum<TestAllTypesProto3_NestedEnum, TestAllTypesProto3_NestedEnumJson>;
...
/**
 * JSON type for the enum protobuf_test_messages.proto3.TestAllTypesProto3.AliasedEnum.
 */
export declare type TestAllTypesProto3_AliasedEnumJson = "ALIAS_FOO" | "ALIAS_BAR" | "ALIAS_BAZ" | "MOO" | "moo" | "bAz";

/**
 * Describes the enum protobuf_test_messages.proto3.TestAllTypesProto3.AliasedEnum.
 */
export declare const TestAllTypesProto3_AliasedEnumSchema: GenDescEnum<TestAllTypesProto3_AliasedEnum, TestAllTypesProto3_AliasedEnumJson>;

/**
 * @generated from message protobuf_test_messages.proto3.ForeignMessage
 */
export declare type ForeignMessage = Message<"protobuf_test_messages.proto3.ForeignMessage"> & {
  /**
...
/**
 * JSON type for the message protobuf_test_messages.proto3.ForeignMessage.
 */
...
/**
 * JSON type for the message protobuf_test_messages.proto3.NullHypothesisProto3.
 */
export declare type NullHypothesisProto3Json = {
};
 ...
 */
export declare const NullHypothesisProto3Schema: GenDescMessage<NullHypothesisProto3, NullHypothesisProto3Json>;
...
/**
 * JSON type for the message protobuf_test_messages.proto3.EnumOnlyProto3.
 */
export declare type EnumOnlyProto3Json = {
};
 ...
 */
export declare const EnumOnlyProto3Schema: GenDescMessage<EnumOnlyProto3, EnumOnlyProto3Json>;
...
/**
 * JSON type for the enum protobuf_test_messages.proto3.EnumOnlyProto3.Bool.
 */
export declare type EnumOnlyProto3_BoolJson = "kFalse" | "kTrue";

/**
 * Describes the enum protobuf_test_messages.proto3.EnumOnlyProto3.Bool.
 */
export declare const EnumOnlyProto3_BoolSchema: GenDescEnum<EnumOnlyProto3_Bool, EnumOnlyProto3_BoolJson>;
...
/**
 * JSON type for the enum protobuf_test_messages.proto3.ForeignEnum.
 */
export declare type ForeignEnumJson = "FOREIGN_FOO" | "FOREIGN_BAR" | "FOREIGN_BAZ";
