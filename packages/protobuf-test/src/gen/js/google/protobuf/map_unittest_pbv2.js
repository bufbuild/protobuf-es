...
export const TestMapSubmessageDesc = messageDesc(fileDesc_google_protobuf_map_unittest, 1);

// Describes the message protobuf_unittest.TestMessageMap. Use `create(TestMessageMapDesc)` to create a new TestMessageMap.
export const TestMessageMapDesc = messageDesc(fileDesc_google_protobuf_map_unittest, 2);

// Describes the message protobuf_unittest.TestSameTypeMap. Use `create(TestSameTypeMapDesc)` to create a new TestSameTypeMap.
export const TestSameTypeMapDesc = messageDesc(fileDesc_google_protobuf_map_unittest, 3);
...
export const TestRequiredMessageMapDesc = messageDesc(fileDesc_google_protobuf_map_unittest, 4);

// Describes the message protobuf_unittest.TestArenaMap. Use `create(TestArenaMapDesc)` to create a new TestArenaMap.
export const TestArenaMapDesc = messageDesc(fileDesc_google_protobuf_map_unittest, 5);
...
export const MessageContainingEnumCalledTypeDesc = messageDesc(fileDesc_google_protobuf_map_unittest, 6);

// Describes the enum protobuf_unittest.MessageContainingEnumCalledType.Type.
export const MessageContainingEnumCalledType_TypeDesc = enumDesc(fileDesc_google_protobuf_map_unittest, 6, 0);

/**
 * @generated from enum protobuf_unittest.MessageContainingEnumCalledType.Type
 */
export const MessageContainingEnumCalledType_Type = tsEnum(MessageContainingEnumCalledType_TypeDesc);
...
export const MessageContainingMapCalledEntryDesc = messageDesc(fileDesc_google_protobuf_map_unittest, 7);
...
export const TestRecursiveMapMessageDesc = messageDesc(fileDesc_google_protobuf_map_unittest, 8);

// Describes the message protobuf_unittest.TestI32StrMap. Use `create(TestI32StrMapDesc)` to create a new TestI32StrMap.
export const TestI32StrMapDesc = messageDesc(fileDesc_google_protobuf_map_unittest, 9);

// Describes the enum protobuf_unittest.MapEnum.
export const MapEnumDesc = enumDesc(fileDesc_google_protobuf_map_unittest, 0);

/**
 * @generated from enum protobuf_unittest.MapEnum
 */
export const MapEnum = tsEnum(MapEnumDesc);
