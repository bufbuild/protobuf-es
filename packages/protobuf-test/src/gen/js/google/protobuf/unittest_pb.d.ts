 ...
 */
export declare type TestRequiredOpenEnum = Message<"protobuf_unittest.TestRequiredOpenEnum"> & {
  /**
 ...
 */
export declare type OpenEnumMessage = Message<"protobuf_unittest.OpenEnumMessage"> & {
  /**
