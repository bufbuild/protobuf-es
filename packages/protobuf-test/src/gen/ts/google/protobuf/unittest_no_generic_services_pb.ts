 ...
 */
export const file_google_protobuf_unittest_no_generic_services: GenDescFile = /*@__PURE__*/
 ...
 */
export const TestEnumSchema: GenDescEnum<TestEnum, TestEnumJson> = /*@__PURE__*/
