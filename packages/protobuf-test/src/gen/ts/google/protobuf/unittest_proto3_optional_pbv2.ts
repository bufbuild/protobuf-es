...
export const TestProto3OptionalDesc: TypedDescMessage<TestProto3Optional> = messageDesc(fileDesc_google_protobuf_unittest_proto3_optional, 0);
...
export const TestProto3Optional_NestedMessageDesc: TypedDescMessage<TestProto3Optional_NestedMessage> = messageDesc(fileDesc_google_protobuf_unittest_proto3_optional, 0, 0);
...
export const TestProto3Optional_NestedEnumDesc: TypedDescEnum<TestProto3Optional_NestedEnum> = enumDesc(fileDesc_google_protobuf_unittest_proto3_optional, 0, 0);
...
export const TestProto3OptionalMessageDesc: TypedDescMessage<TestProto3OptionalMessage> = messageDesc(fileDesc_google_protobuf_unittest_proto3_optional, 1);
...
export const TestProto3OptionalMessage_NestedMessageDesc: TypedDescMessage<TestProto3OptionalMessage_NestedMessage> = messageDesc(fileDesc_google_protobuf_unittest_proto3_optional, 1, 0);
...
export const Proto3OptionalExtensionsDesc: TypedDescMessage<Proto3OptionalExtensions> = messageDesc(fileDesc_google_protobuf_unittest_proto3_optional, 2);

/**
 * @generated from extension: int32 ext_no_optional = 355886728;
 */
export const Proto3OptionalExtensions_ext_no_optional: TypedDescExtension<MessageOptions, number> = extDesc(fileDesc_google_protobuf_unittest_proto3_optional, 2, 0);

/**
 * @generated from extension: optional int32 ext_with_optional = 355886729;
 */
export const Proto3OptionalExtensions_ext_with_optional: TypedDescExtension<MessageOptions, number> = extDesc(fileDesc_google_protobuf_unittest_proto3_optional, 2, 1);
