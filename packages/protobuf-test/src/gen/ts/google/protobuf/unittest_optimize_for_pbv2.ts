...
export const fileDesc_google_protobuf_unittest_optimize_for: DescFile = fileDesc("", [fileDesc_google_protobuf_unittest]);
...
export const TestOptimizedForSizeDesc: TypedDescMessage<TestOptimizedForSize> = messageDesc(fileDesc_google_protobuf_unittest_optimize_for, 0);

/**
 * @generated from extension: optional int32 test_extension = 1234;
 */
export const TestOptimizedForSize_test_extension: TypedDescExtension<TestOptimizedForSize, number> = extDesc(fileDesc_google_protobuf_unittest_optimize_for, 0, 0);

/**
 * @generated from extension: optional protobuf_unittest.TestRequiredOptimizedForSize test_extension2 = 1235;
 */
export const TestOptimizedForSize_test_extension2: TypedDescExtension<TestOptimizedForSize, TestRequiredOptimizedForSize> = extDesc(fileDesc_google_protobuf_unittest_optimize_for, 0, 1);
...
export const TestRequiredOptimizedForSizeDesc: TypedDescMessage<TestRequiredOptimizedForSize> = messageDesc(fileDesc_google_protobuf_unittest_optimize_for, 1);
...
export const TestOptionalOptimizedForSizeDesc: TypedDescMessage<TestOptionalOptimizedForSize> = messageDesc(fileDesc_google_protobuf_unittest_optimize_for, 2);
