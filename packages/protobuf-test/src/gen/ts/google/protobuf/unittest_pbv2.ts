...
export const TestAllTypesDesc: TypedDescMessage<TestAllTypes> = messageDesc(fileDesc_google_protobuf_unittest, 0);
...
export const TestAllTypes_NestedMessageDesc: TypedDescMessage<TestAllTypes_NestedMessage> = messageDesc(fileDesc_google_protobuf_unittest, 0, 0);
...
export const TestAllTypes_OptionalGroupDesc: TypedDescMessage<TestAllTypes_OptionalGroup> = messageDesc(fileDesc_google_protobuf_unittest, 0, 1);
...
export const TestAllTypes_RepeatedGroupDesc: TypedDescMessage<TestAllTypes_RepeatedGroup> = messageDesc(fileDesc_google_protobuf_unittest, 0, 2);
...
export const TestAllTypes_NestedEnumDesc: TypedDescEnum<TestAllTypes_NestedEnum> = enumDesc(fileDesc_google_protobuf_unittest, 0, 0);
...
export const NestedTestAllTypesDesc: TypedDescMessage<NestedTestAllTypes> = messageDesc(fileDesc_google_protobuf_unittest, 1);
...
export const TestDeprecatedFieldsDesc: TypedDescMessage<TestDeprecatedFields> = messageDesc(fileDesc_google_protobuf_unittest, 2);
...
export const TestDeprecatedMessageDesc: TypedDescMessage<TestDeprecatedMessage> = messageDesc(fileDesc_google_protobuf_unittest, 3);
...
export const ForeignMessageDesc: TypedDescMessage<ForeignMessage> = messageDesc(fileDesc_google_protobuf_unittest, 4);
...
export const TestReservedFieldsDesc: TypedDescMessage<TestReservedFields> = messageDesc(fileDesc_google_protobuf_unittest, 5);
...
export const TestAllExtensionsDesc: TypedDescMessage<TestAllExtensions> = messageDesc(fileDesc_google_protobuf_unittest, 6);
...
export const OptionalGroup_extensionDesc: TypedDescMessage<OptionalGroup_extension> = messageDesc(fileDesc_google_protobuf_unittest, 7);
...
export const RepeatedGroup_extensionDesc: TypedDescMessage<RepeatedGroup_extension> = messageDesc(fileDesc_google_protobuf_unittest, 8);
...
export const TestMixedFieldsAndExtensionsDesc: TypedDescMessage<TestMixedFieldsAndExtensions> = messageDesc(fileDesc_google_protobuf_unittest, 9);

/**
 * @generated from extension: optional int32 c = 2;
 */
export const TestMixedFieldsAndExtensions_c: TypedDescExtension<TestMixedFieldsAndExtensions, number> = extDesc(fileDesc_google_protobuf_unittest, 9, 0);

/**
 * @generated from extension: repeated fixed32 d = 4;
 */
export const TestMixedFieldsAndExtensions_d: TypedDescExtension<TestMixedFieldsAndExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 9, 1);
...
export const TestGroupDesc: TypedDescMessage<TestGroup> = messageDesc(fileDesc_google_protobuf_unittest, 10);
...
export const TestGroup_OptionalGroupDesc: TypedDescMessage<TestGroup_OptionalGroup> = messageDesc(fileDesc_google_protobuf_unittest, 10, 0);
...
export const TestGroupExtensionDesc: TypedDescMessage<TestGroupExtension> = messageDesc(fileDesc_google_protobuf_unittest, 11);
...
export const TestNestedExtensionDesc: TypedDescMessage<TestNestedExtension> = messageDesc(fileDesc_google_protobuf_unittest, 12);
...
export const TestNestedExtension_OptionalGroup_extensionDesc: TypedDescMessage<TestNestedExtension_OptionalGroup_extension> = messageDesc(fileDesc_google_protobuf_unittest, 12, 0);
 ...
 */
export const TestNestedExtension_test: TypedDescExtension<TestAllExtensions, string> = extDesc(fileDesc_google_protobuf_unittest, 12, 0);
 ...
 */
export const TestNestedExtension_nested_string_extension: TypedDescExtension<TestAllExtensions, string> = extDesc(fileDesc_google_protobuf_unittest, 12, 1);
 ...
 */
export const TestNestedExtension_optionalgroup_extension: TypedDescExtension<TestGroupExtension, TestNestedExtension_OptionalGroup_extension> = extDesc(fileDesc_google_protobuf_unittest, 12, 2);

/**
 * @generated from extension: optional protobuf_unittest.ForeignEnum optional_foreign_enum_extension = 22;
 */
export const TestNestedExtension_optional_foreign_enum_extension: TypedDescExtension<TestGroupExtension, ForeignEnum> = extDesc(fileDesc_google_protobuf_unittest, 12, 3);
...
export const TestChildExtensionDesc: TypedDescMessage<TestChildExtension> = messageDesc(fileDesc_google_protobuf_unittest, 13);
...
export const TestChildExtensionDataDesc: TypedDescMessage<TestChildExtensionData> = messageDesc(fileDesc_google_protobuf_unittest, 14);
...
export const TestChildExtensionData_NestedTestAllExtensionsDataDesc: TypedDescMessage<TestChildExtensionData_NestedTestAllExtensionsData> = messageDesc(fileDesc_google_protobuf_unittest, 14, 0);
...
export const TestChildExtensionData_NestedTestAllExtensionsData_NestedDynamicExtensionsDesc: TypedDescMessage<TestChildExtensionData_NestedTestAllExtensionsData_NestedDynamicExtensions> = messageDesc(fileDesc_google_protobuf_unittest, 14, 0, 0);
...
export const TestNestedChildExtensionDesc: TypedDescMessage<TestNestedChildExtension> = messageDesc(fileDesc_google_protobuf_unittest, 15);
...
export const TestNestedChildExtensionDataDesc: TypedDescMessage<TestNestedChildExtensionData> = messageDesc(fileDesc_google_protobuf_unittest, 16);
...
export const TestRequiredEnumDesc: TypedDescMessage<TestRequiredEnum> = messageDesc(fileDesc_google_protobuf_unittest, 17);
...
export const TestRequiredEnumNoMaskDesc: TypedDescMessage<TestRequiredEnumNoMask> = messageDesc(fileDesc_google_protobuf_unittest, 18);
...
export const TestRequiredEnumNoMask_NestedEnumDesc: TypedDescEnum<TestRequiredEnumNoMask_NestedEnum> = enumDesc(fileDesc_google_protobuf_unittest, 18, 0);
...
export const TestRequiredEnumMultiDesc: TypedDescMessage<TestRequiredEnumMulti> = messageDesc(fileDesc_google_protobuf_unittest, 19);
...
export const TestRequiredEnumMulti_NestedEnumDesc: TypedDescEnum<TestRequiredEnumMulti_NestedEnum> = enumDesc(fileDesc_google_protobuf_unittest, 19, 0);
...
export const TestRequiredNoMaskMultiDesc: TypedDescMessage<TestRequiredNoMaskMulti> = messageDesc(fileDesc_google_protobuf_unittest, 20);
...
export const TestRequiredNoMaskMulti_NestedEnumDesc: TypedDescEnum<TestRequiredNoMaskMulti_NestedEnum> = enumDesc(fileDesc_google_protobuf_unittest, 20, 0);
...
export const TestRequiredDesc: TypedDescMessage<TestRequired> = messageDesc(fileDesc_google_protobuf_unittest, 21);

/**
 * @generated from extension: optional protobuf_unittest.TestRequired single = 1000;
 */
export const TestRequired_single: TypedDescExtension<TestAllExtensions, TestRequired> = extDesc(fileDesc_google_protobuf_unittest, 21, 0);

/**
 * @generated from extension: repeated protobuf_unittest.TestRequired multi = 1001;
 */
export const TestRequired_multi: TypedDescExtension<TestAllExtensions, TestRequired[]> = extDesc(fileDesc_google_protobuf_unittest, 21, 1);
...
export const TestRequiredForeignDesc: TypedDescMessage<TestRequiredForeign> = messageDesc(fileDesc_google_protobuf_unittest, 22);
...
export const TestRequiredMessageDesc: TypedDescMessage<TestRequiredMessage> = messageDesc(fileDesc_google_protobuf_unittest, 23);
...
export const TestNestedRequiredForeignDesc: TypedDescMessage<TestNestedRequiredForeign> = messageDesc(fileDesc_google_protobuf_unittest, 24);
...
export const TestForeignNestedDesc: TypedDescMessage<TestForeignNested> = messageDesc(fileDesc_google_protobuf_unittest, 25);
...
export const TestEmptyMessageDesc: TypedDescMessage<TestEmptyMessage> = messageDesc(fileDesc_google_protobuf_unittest, 26);
...
export const TestEmptyMessageWithExtensionsDesc: TypedDescMessage<TestEmptyMessageWithExtensions> = messageDesc(fileDesc_google_protobuf_unittest, 27);
...
export const TestPickleNestedMessageDesc: TypedDescMessage<TestPickleNestedMessage> = messageDesc(fileDesc_google_protobuf_unittest, 28);
...
export const TestPickleNestedMessage_NestedMessageDesc: TypedDescMessage<TestPickleNestedMessage_NestedMessage> = messageDesc(fileDesc_google_protobuf_unittest, 28, 0);
...
export const TestPickleNestedMessage_NestedMessage_NestedNestedMessageDesc: TypedDescMessage<TestPickleNestedMessage_NestedMessage_NestedNestedMessage> = messageDesc(fileDesc_google_protobuf_unittest, 28, 0, 0);
...
export const TestMultipleExtensionRangesDesc: TypedDescMessage<TestMultipleExtensionRanges> = messageDesc(fileDesc_google_protobuf_unittest, 29);
...
export const TestReallyLargeTagNumberDesc: TypedDescMessage<TestReallyLargeTagNumber> = messageDesc(fileDesc_google_protobuf_unittest, 30);
...
export const TestRecursiveMessageDesc: TypedDescMessage<TestRecursiveMessage> = messageDesc(fileDesc_google_protobuf_unittest, 31);
...
export const TestMutualRecursionADesc: TypedDescMessage<TestMutualRecursionA> = messageDesc(fileDesc_google_protobuf_unittest, 32);
...
export const TestMutualRecursionA_SubMessageDesc: TypedDescMessage<TestMutualRecursionA_SubMessage> = messageDesc(fileDesc_google_protobuf_unittest, 32, 0);
...
export const TestMutualRecursionA_SubGroupDesc: TypedDescMessage<TestMutualRecursionA_SubGroup> = messageDesc(fileDesc_google_protobuf_unittest, 32, 1);
...
export const TestMutualRecursionA_SubGroupRDesc: TypedDescMessage<TestMutualRecursionA_SubGroupR> = messageDesc(fileDesc_google_protobuf_unittest, 32, 2);
...
export const TestMutualRecursionBDesc: TypedDescMessage<TestMutualRecursionB> = messageDesc(fileDesc_google_protobuf_unittest, 33);
...
export const TestIsInitializedDesc: TypedDescMessage<TestIsInitialized> = messageDesc(fileDesc_google_protobuf_unittest, 34);
...
export const TestIsInitialized_SubMessageDesc: TypedDescMessage<TestIsInitialized_SubMessage> = messageDesc(fileDesc_google_protobuf_unittest, 34, 0);
...
export const TestIsInitialized_SubMessage_SubGroupDesc: TypedDescMessage<TestIsInitialized_SubMessage_SubGroup> = messageDesc(fileDesc_google_protobuf_unittest, 34, 0, 0);
...
export const TestDupFieldNumberDesc: TypedDescMessage<TestDupFieldNumber> = messageDesc(fileDesc_google_protobuf_unittest, 35);
...
export const TestDupFieldNumber_FooDesc: TypedDescMessage<TestDupFieldNumber_Foo> = messageDesc(fileDesc_google_protobuf_unittest, 35, 0);
...
export const TestDupFieldNumber_BarDesc: TypedDescMessage<TestDupFieldNumber_Bar> = messageDesc(fileDesc_google_protobuf_unittest, 35, 1);
...
export const TestEagerMessageDesc: TypedDescMessage<TestEagerMessage> = messageDesc(fileDesc_google_protobuf_unittest, 36);
...
export const TestLazyMessageDesc: TypedDescMessage<TestLazyMessage> = messageDesc(fileDesc_google_protobuf_unittest, 37);
...
export const TestLazyMessageRepeatedDesc: TypedDescMessage<TestLazyMessageRepeated> = messageDesc(fileDesc_google_protobuf_unittest, 38);
...
export const TestEagerMaybeLazyDesc: TypedDescMessage<TestEagerMaybeLazy> = messageDesc(fileDesc_google_protobuf_unittest, 39);
...
export const TestEagerMaybeLazy_NestedMessageDesc: TypedDescMessage<TestEagerMaybeLazy_NestedMessage> = messageDesc(fileDesc_google_protobuf_unittest, 39, 0);
...
export const TestNestedMessageHasBitsDesc: TypedDescMessage<TestNestedMessageHasBits> = messageDesc(fileDesc_google_protobuf_unittest, 40);
...
export const TestNestedMessageHasBits_NestedMessageDesc: TypedDescMessage<TestNestedMessageHasBits_NestedMessage> = messageDesc(fileDesc_google_protobuf_unittest, 40, 0);
...
export const TestCamelCaseFieldNamesDesc: TypedDescMessage<TestCamelCaseFieldNames> = messageDesc(fileDesc_google_protobuf_unittest, 41);
...
export const TestFieldOrderingsDesc: TypedDescMessage<TestFieldOrderings> = messageDesc(fileDesc_google_protobuf_unittest, 42);
...
export const TestFieldOrderings_NestedMessageDesc: TypedDescMessage<TestFieldOrderings_NestedMessage> = messageDesc(fileDesc_google_protobuf_unittest, 42, 0);
...
export const TestExtensionOrderings1Desc: TypedDescMessage<TestExtensionOrderings1> = messageDesc(fileDesc_google_protobuf_unittest, 43);

/**
 * @generated from extension: optional protobuf_unittest.TestExtensionOrderings1 test_ext_orderings1 = 13;
 */
export const TestExtensionOrderings1_test_ext_orderings1: TypedDescExtension<TestFieldOrderings, TestExtensionOrderings1> = extDesc(fileDesc_google_protobuf_unittest, 43, 0);
...
export const TestExtensionOrderings2Desc: TypedDescMessage<TestExtensionOrderings2> = messageDesc(fileDesc_google_protobuf_unittest, 44);
...
export const TestExtensionOrderings2_TestExtensionOrderings3Desc: TypedDescMessage<TestExtensionOrderings2_TestExtensionOrderings3> = messageDesc(fileDesc_google_protobuf_unittest, 44, 0);
 ...
 */
export const TestExtensionOrderings2_TestExtensionOrderings3_test_ext_orderings3: TypedDescExtension<TestFieldOrderings, TestExtensionOrderings2_TestExtensionOrderings3> = extDesc(fileDesc_google_protobuf_unittest, 44, 0, 0);

/**
 * @generated from extension: optional protobuf_unittest.TestExtensionOrderings2 test_ext_orderings2 = 12;
 */
export const TestExtensionOrderings2_test_ext_orderings2: TypedDescExtension<TestFieldOrderings, TestExtensionOrderings2> = extDesc(fileDesc_google_protobuf_unittest, 44, 0);
...
export const TestExtremeDefaultValuesDesc: TypedDescMessage<TestExtremeDefaultValues> = messageDesc(fileDesc_google_protobuf_unittest, 45);
...
export const SparseEnumMessageDesc: TypedDescMessage<SparseEnumMessage> = messageDesc(fileDesc_google_protobuf_unittest, 46);
...
export const OneStringDesc: TypedDescMessage<OneString> = messageDesc(fileDesc_google_protobuf_unittest, 47);
...
export const MoreStringDesc: TypedDescMessage<MoreString> = messageDesc(fileDesc_google_protobuf_unittest, 48);
...
export const OneBytesDesc: TypedDescMessage<OneBytes> = messageDesc(fileDesc_google_protobuf_unittest, 49);
...
export const MoreBytesDesc: TypedDescMessage<MoreBytes> = messageDesc(fileDesc_google_protobuf_unittest, 50);
...
export const ManyOptionalStringDesc: TypedDescMessage<ManyOptionalString> = messageDesc(fileDesc_google_protobuf_unittest, 51);
...
export const Int32MessageDesc: TypedDescMessage<Int32Message> = messageDesc(fileDesc_google_protobuf_unittest, 52);
...
export const Uint32MessageDesc: TypedDescMessage<Uint32Message> = messageDesc(fileDesc_google_protobuf_unittest, 53);
...
export const Int64MessageDesc: TypedDescMessage<Int64Message> = messageDesc(fileDesc_google_protobuf_unittest, 54);
...
export const Uint64MessageDesc: TypedDescMessage<Uint64Message> = messageDesc(fileDesc_google_protobuf_unittest, 55);
...
export const BoolMessageDesc: TypedDescMessage<BoolMessage> = messageDesc(fileDesc_google_protobuf_unittest, 56);
...
export const TestOneofDesc: TypedDescMessage<TestOneof> = messageDesc(fileDesc_google_protobuf_unittest, 57);
...
export const TestOneof_FooGroupDesc: TypedDescMessage<TestOneof_FooGroup> = messageDesc(fileDesc_google_protobuf_unittest, 57, 0);
...
export const TestOneofBackwardsCompatibleDesc: TypedDescMessage<TestOneofBackwardsCompatible> = messageDesc(fileDesc_google_protobuf_unittest, 58);
...
export const TestOneofBackwardsCompatible_FooGroupDesc: TypedDescMessage<TestOneofBackwardsCompatible_FooGroup> = messageDesc(fileDesc_google_protobuf_unittest, 58, 0);
...
export const TestOneof2Desc: TypedDescMessage<TestOneof2> = messageDesc(fileDesc_google_protobuf_unittest, 59);
...
export const TestOneof2_FooGroupDesc: TypedDescMessage<TestOneof2_FooGroup> = messageDesc(fileDesc_google_protobuf_unittest, 59, 0);
...
export const TestOneof2_NestedMessageDesc: TypedDescMessage<TestOneof2_NestedMessage> = messageDesc(fileDesc_google_protobuf_unittest, 59, 1);
...
export const TestOneof2_NestedEnumDesc: TypedDescEnum<TestOneof2_NestedEnum> = enumDesc(fileDesc_google_protobuf_unittest, 59, 0);
...
export const TestRequiredOneofDesc: TypedDescMessage<TestRequiredOneof> = messageDesc(fileDesc_google_protobuf_unittest, 60);
...
export const TestRequiredOneof_NestedMessageDesc: TypedDescMessage<TestRequiredOneof_NestedMessage> = messageDesc(fileDesc_google_protobuf_unittest, 60, 0);
...
export const TestPackedTypesDesc: TypedDescMessage<TestPackedTypes> = messageDesc(fileDesc_google_protobuf_unittest, 61);
...
export const TestUnpackedTypesDesc: TypedDescMessage<TestUnpackedTypes> = messageDesc(fileDesc_google_protobuf_unittest, 62);
...
export const TestPackedExtensionsDesc: TypedDescMessage<TestPackedExtensions> = messageDesc(fileDesc_google_protobuf_unittest, 63);
...
export const TestUnpackedExtensionsDesc: TypedDescMessage<TestUnpackedExtensions> = messageDesc(fileDesc_google_protobuf_unittest, 64);
...
export const TestDynamicExtensionsDesc: TypedDescMessage<TestDynamicExtensions> = messageDesc(fileDesc_google_protobuf_unittest, 65);
...
export const TestDynamicExtensions_DynamicMessageTypeDesc: TypedDescMessage<TestDynamicExtensions_DynamicMessageType> = messageDesc(fileDesc_google_protobuf_unittest, 65, 0);
...
export const TestDynamicExtensions_DynamicEnumTypeDesc: TypedDescEnum<TestDynamicExtensions_DynamicEnumType> = enumDesc(fileDesc_google_protobuf_unittest, 65, 0);
...
export const TestRepeatedStringDesc: TypedDescMessage<TestRepeatedString> = messageDesc(fileDesc_google_protobuf_unittest, 66);
...
export const TestRepeatedScalarDifferentTagSizesDesc: TypedDescMessage<TestRepeatedScalarDifferentTagSizes> = messageDesc(fileDesc_google_protobuf_unittest, 67);
...
export const TestParsingMergeDesc: TypedDescMessage<TestParsingMerge> = messageDesc(fileDesc_google_protobuf_unittest, 68);
...
export const TestParsingMerge_RepeatedFieldsGeneratorDesc: TypedDescMessage<TestParsingMerge_RepeatedFieldsGenerator> = messageDesc(fileDesc_google_protobuf_unittest, 68, 0);
...
export const TestParsingMerge_RepeatedFieldsGenerator_Group1Desc: TypedDescMessage<TestParsingMerge_RepeatedFieldsGenerator_Group1> = messageDesc(fileDesc_google_protobuf_unittest, 68, 0, 0);
...
export const TestParsingMerge_RepeatedFieldsGenerator_Group2Desc: TypedDescMessage<TestParsingMerge_RepeatedFieldsGenerator_Group2> = messageDesc(fileDesc_google_protobuf_unittest, 68, 0, 1);
...
export const TestParsingMerge_OptionalGroupDesc: TypedDescMessage<TestParsingMerge_OptionalGroup> = messageDesc(fileDesc_google_protobuf_unittest, 68, 1);
...
export const TestParsingMerge_RepeatedGroupDesc: TypedDescMessage<TestParsingMerge_RepeatedGroup> = messageDesc(fileDesc_google_protobuf_unittest, 68, 2);

/**
 * @generated from extension: optional protobuf_unittest.TestAllTypes optional_ext = 1000;
 */
export const TestParsingMerge_optional_ext: TypedDescExtension<TestParsingMerge, TestAllTypes> = extDesc(fileDesc_google_protobuf_unittest, 68, 0);

/**
 * @generated from extension: repeated protobuf_unittest.TestAllTypes repeated_ext = 1001;
 */
export const TestParsingMerge_repeated_ext: TypedDescExtension<TestParsingMerge, TestAllTypes[]> = extDesc(fileDesc_google_protobuf_unittest, 68, 1);
...
export const TestMergeExceptionDesc: TypedDescMessage<TestMergeException> = messageDesc(fileDesc_google_protobuf_unittest, 69);
...
export const TestCommentInjectionMessageDesc: TypedDescMessage<TestCommentInjectionMessage> = messageDesc(fileDesc_google_protobuf_unittest, 70);
...
export const TestMessageSizeDesc: TypedDescMessage<TestMessageSize> = messageDesc(fileDesc_google_protobuf_unittest, 71);
...
export const FooRequestDesc: TypedDescMessage<FooRequest> = messageDesc(fileDesc_google_protobuf_unittest, 72);
...
export const FooResponseDesc: TypedDescMessage<FooResponse> = messageDesc(fileDesc_google_protobuf_unittest, 73);
...
export const FooClientMessageDesc: TypedDescMessage<FooClientMessage> = messageDesc(fileDesc_google_protobuf_unittest, 74);
...
export const FooServerMessageDesc: TypedDescMessage<FooServerMessage> = messageDesc(fileDesc_google_protobuf_unittest, 75);
...
export const BarRequestDesc: TypedDescMessage<BarRequest> = messageDesc(fileDesc_google_protobuf_unittest, 76);
...
export const BarResponseDesc: TypedDescMessage<BarResponse> = messageDesc(fileDesc_google_protobuf_unittest, 77);
...
export const TestJsonNameDesc: TypedDescMessage<TestJsonName> = messageDesc(fileDesc_google_protobuf_unittest, 78);
...
export const TestHugeFieldNumbersDesc: TypedDescMessage<TestHugeFieldNumbers> = messageDesc(fileDesc_google_protobuf_unittest, 79);
...
export const TestHugeFieldNumbers_OptionalGroupDesc: TypedDescMessage<TestHugeFieldNumbers_OptionalGroup> = messageDesc(fileDesc_google_protobuf_unittest, 79, 0);
...
export const TestExtensionInsideTableDesc: TypedDescMessage<TestExtensionInsideTable> = messageDesc(fileDesc_google_protobuf_unittest, 80);
...
export const TestNestedGroupExtensionOuterDesc: TypedDescMessage<TestNestedGroupExtensionOuter> = messageDesc(fileDesc_google_protobuf_unittest, 81);
...
export const TestNestedGroupExtensionOuter_Layer1OptionalGroupDesc: TypedDescMessage<TestNestedGroupExtensionOuter_Layer1OptionalGroup> = messageDesc(fileDesc_google_protobuf_unittest, 81, 0);
...
export const TestNestedGroupExtensionOuter_Layer1OptionalGroup_Layer2RepeatedGroupDesc: TypedDescMessage<TestNestedGroupExtensionOuter_Layer1OptionalGroup_Layer2RepeatedGroup> = messageDesc(fileDesc_google_protobuf_unittest, 81, 0, 0);
...
export const TestNestedGroupExtensionOuter_Layer1OptionalGroup_Layer2AnotherOptionalRepeatedGroupDesc: TypedDescMessage<TestNestedGroupExtensionOuter_Layer1OptionalGroup_Layer2AnotherOptionalRepeatedGroup> = messageDesc(fileDesc_google_protobuf_unittest, 81, 0, 1);
...
export const TestNestedGroupExtensionInnerExtensionDesc: TypedDescMessage<TestNestedGroupExtensionInnerExtension> = messageDesc(fileDesc_google_protobuf_unittest, 82);
...
export const TestExtensionRangeSerializeDesc: TypedDescMessage<TestExtensionRangeSerialize> = messageDesc(fileDesc_google_protobuf_unittest, 83);

/**
 * @generated from extension: optional int32 bar_one = 2;
 */
export const TestExtensionRangeSerialize_bar_one: TypedDescExtension<TestExtensionRangeSerialize, number> = extDesc(fileDesc_google_protobuf_unittest, 83, 0);

/**
 * @generated from extension: optional int32 bar_two = 4;
 */
export const TestExtensionRangeSerialize_bar_two: TypedDescExtension<TestExtensionRangeSerialize, number> = extDesc(fileDesc_google_protobuf_unittest, 83, 1);

/**
 * @generated from extension: optional int32 bar_three = 10;
 */
export const TestExtensionRangeSerialize_bar_three: TypedDescExtension<TestExtensionRangeSerialize, number> = extDesc(fileDesc_google_protobuf_unittest, 83, 2);

/**
 * @generated from extension: optional int32 bar_four = 15;
 */
export const TestExtensionRangeSerialize_bar_four: TypedDescExtension<TestExtensionRangeSerialize, number> = extDesc(fileDesc_google_protobuf_unittest, 83, 3);

/**
 * @generated from extension: optional int32 bar_five = 19;
 */
export const TestExtensionRangeSerialize_bar_five: TypedDescExtension<TestExtensionRangeSerialize, number> = extDesc(fileDesc_google_protobuf_unittest, 83, 4);
...
export const TestVerifyInt32SimpleDesc: TypedDescMessage<TestVerifyInt32Simple> = messageDesc(fileDesc_google_protobuf_unittest, 84);
...
export const TestVerifyInt32Desc: TypedDescMessage<TestVerifyInt32> = messageDesc(fileDesc_google_protobuf_unittest, 85);
...
export const TestVerifyMostlyInt32Desc: TypedDescMessage<TestVerifyMostlyInt32> = messageDesc(fileDesc_google_protobuf_unittest, 86);
...
export const TestVerifyMostlyInt32BigFieldNumberDesc: TypedDescMessage<TestVerifyMostlyInt32BigFieldNumber> = messageDesc(fileDesc_google_protobuf_unittest, 87);
...
export const TestVerifyUint32SimpleDesc: TypedDescMessage<TestVerifyUint32Simple> = messageDesc(fileDesc_google_protobuf_unittest, 88);
...
export const TestVerifyUint32Desc: TypedDescMessage<TestVerifyUint32> = messageDesc(fileDesc_google_protobuf_unittest, 89);
...
export const TestVerifyOneUint32Desc: TypedDescMessage<TestVerifyOneUint32> = messageDesc(fileDesc_google_protobuf_unittest, 90);
...
export const TestVerifyOneInt32BigFieldNumberDesc: TypedDescMessage<TestVerifyOneInt32BigFieldNumber> = messageDesc(fileDesc_google_protobuf_unittest, 91);
...
export const TestVerifyInt32BigFieldNumberDesc: TypedDescMessage<TestVerifyInt32BigFieldNumber> = messageDesc(fileDesc_google_protobuf_unittest, 92);
...
export const TestVerifyUint32BigFieldNumberDesc: TypedDescMessage<TestVerifyUint32BigFieldNumber> = messageDesc(fileDesc_google_protobuf_unittest, 93);
...
export const TestVerifyBigFieldNumberUint32Desc: TypedDescMessage<TestVerifyBigFieldNumberUint32> = messageDesc(fileDesc_google_protobuf_unittest, 94);
...
export const TestVerifyBigFieldNumberUint32_NestedDesc: TypedDescMessage<TestVerifyBigFieldNumberUint32_Nested> = messageDesc(fileDesc_google_protobuf_unittest, 94, 0);
...
export const EnumParseTesterDesc: TypedDescMessage<EnumParseTester> = messageDesc(fileDesc_google_protobuf_unittest, 95);
...
export const EnumParseTester_SeqSmall0Desc: TypedDescEnum<EnumParseTester_SeqSmall0> = enumDesc(fileDesc_google_protobuf_unittest, 95, 0);
...
export const EnumParseTester_SeqSmall1Desc: TypedDescEnum<EnumParseTester_SeqSmall1> = enumDesc(fileDesc_google_protobuf_unittest, 95, 1);
...
export const EnumParseTester_SeqLargeDesc: TypedDescEnum<EnumParseTester_SeqLarge> = enumDesc(fileDesc_google_protobuf_unittest, 95, 2);
...
export const EnumParseTester_ArbitraryDesc: TypedDescEnum<EnumParseTester_Arbitrary> = enumDesc(fileDesc_google_protobuf_unittest, 95, 3);

/**
 * @generated from extension: optional protobuf_unittest.EnumParseTester.Arbitrary optional_arbitrary_ext = 2000000;
 */
export const EnumParseTester_optional_arbitrary_ext: TypedDescExtension<EnumParseTester, EnumParseTester_Arbitrary> = extDesc(fileDesc_google_protobuf_unittest, 95, 0);

/**
 * @generated from extension: repeated protobuf_unittest.EnumParseTester.Arbitrary repeated_arbitrary_ext = 2000001;
 */
export const EnumParseTester_repeated_arbitrary_ext: TypedDescExtension<EnumParseTester, EnumParseTester_Arbitrary[]> = extDesc(fileDesc_google_protobuf_unittest, 95, 1);

/**
 * @generated from extension: repeated protobuf_unittest.EnumParseTester.Arbitrary packed_arbitrary_ext = 2000002 [packed = true];
 */
export const EnumParseTester_packed_arbitrary_ext: TypedDescExtension<EnumParseTester, EnumParseTester_Arbitrary[]> = extDesc(fileDesc_google_protobuf_unittest, 95, 2);
...
export const BoolParseTesterDesc: TypedDescMessage<BoolParseTester> = messageDesc(fileDesc_google_protobuf_unittest, 96);

/**
 * @generated from extension: optional bool optional_bool_ext = 2000000;
 */
export const BoolParseTester_optional_bool_ext: TypedDescExtension<BoolParseTester, boolean> = extDesc(fileDesc_google_protobuf_unittest, 96, 0);

/**
 * @generated from extension: repeated bool repeated_bool_ext = 2000001;
 */
export const BoolParseTester_repeated_bool_ext: TypedDescExtension<BoolParseTester, boolean[]> = extDesc(fileDesc_google_protobuf_unittest, 96, 1);

/**
 * @generated from extension: repeated bool packed_bool_ext = 2000002 [packed = true];
 */
export const BoolParseTester_packed_bool_ext: TypedDescExtension<BoolParseTester, boolean[]> = extDesc(fileDesc_google_protobuf_unittest, 96, 2);
...
export const Int32ParseTesterDesc: TypedDescMessage<Int32ParseTester> = messageDesc(fileDesc_google_protobuf_unittest, 97);

/**
 * @generated from extension: optional int32 optional_int32_ext = 2000000;
 */
export const Int32ParseTester_optional_int32_ext: TypedDescExtension<Int32ParseTester, number> = extDesc(fileDesc_google_protobuf_unittest, 97, 0);

/**
 * @generated from extension: repeated int32 repeated_int32_ext = 2000001;
 */
export const Int32ParseTester_repeated_int32_ext: TypedDescExtension<Int32ParseTester, number[]> = extDesc(fileDesc_google_protobuf_unittest, 97, 1);

/**
 * @generated from extension: repeated int32 packed_int32_ext = 2000002 [packed = true];
 */
export const Int32ParseTester_packed_int32_ext: TypedDescExtension<Int32ParseTester, number[]> = extDesc(fileDesc_google_protobuf_unittest, 97, 2);
...
export const Int64ParseTesterDesc: TypedDescMessage<Int64ParseTester> = messageDesc(fileDesc_google_protobuf_unittest, 98);

/**
 * @generated from extension: optional int64 optional_int64_ext = 2000000;
 */
export const Int64ParseTester_optional_int64_ext: TypedDescExtension<Int64ParseTester, bigint> = extDesc(fileDesc_google_protobuf_unittest, 98, 0);

/**
 * @generated from extension: repeated int64 repeated_int64_ext = 2000001;
 */
export const Int64ParseTester_repeated_int64_ext: TypedDescExtension<Int64ParseTester, bigint[]> = extDesc(fileDesc_google_protobuf_unittest, 98, 1);

/**
 * @generated from extension: repeated int64 packed_int64_ext = 2000002 [packed = true];
 */
export const Int64ParseTester_packed_int64_ext: TypedDescExtension<Int64ParseTester, bigint[]> = extDesc(fileDesc_google_protobuf_unittest, 98, 2);
...
export const InlinedStringIdxRegressionProtoDesc: TypedDescMessage<InlinedStringIdxRegressionProto> = messageDesc(fileDesc_google_protobuf_unittest, 99);
...
export const StringParseTesterDesc: TypedDescMessage<StringParseTester> = messageDesc(fileDesc_google_protobuf_unittest, 100);

/**
 * @generated from extension: optional string optional_string_ext = 2000000;
 */
export const StringParseTester_optional_string_ext: TypedDescExtension<StringParseTester, string> = extDesc(fileDesc_google_protobuf_unittest, 100, 0);

/**
 * @generated from extension: repeated string repeated_string_ext = 2000001;
 */
export const StringParseTester_repeated_string_ext: TypedDescExtension<StringParseTester, string[]> = extDesc(fileDesc_google_protobuf_unittest, 100, 1);
...
export const BadFieldNamesDesc: TypedDescMessage<BadFieldNames> = messageDesc(fileDesc_google_protobuf_unittest, 101);
...
export const TestNestedMessageRedactionDesc: TypedDescMessage<TestNestedMessageRedaction> = messageDesc(fileDesc_google_protobuf_unittest, 102);
...
export const RedactedFieldsDesc: TypedDescMessage<RedactedFields> = messageDesc(fileDesc_google_protobuf_unittest, 103);
...
export const TestCordDesc: TypedDescMessage<TestCord> = messageDesc(fileDesc_google_protobuf_unittest, 104);
...
export const TestPackedEnumSmallRangeDesc: TypedDescMessage<TestPackedEnumSmallRange> = messageDesc(fileDesc_google_protobuf_unittest, 105);
...
export const TestPackedEnumSmallRange_NestedEnumDesc: TypedDescEnum<TestPackedEnumSmallRange_NestedEnum> = enumDesc(fileDesc_google_protobuf_unittest, 105, 0);
...
export const EnumsForBenchmarkDesc: TypedDescMessage<EnumsForBenchmark> = messageDesc(fileDesc_google_protobuf_unittest, 106);
...
export const EnumsForBenchmark_FlatDesc: TypedDescEnum<EnumsForBenchmark_Flat> = enumDesc(fileDesc_google_protobuf_unittest, 106, 0);
...
export const EnumsForBenchmark_AlmostFlatDesc: TypedDescEnum<EnumsForBenchmark_AlmostFlat> = enumDesc(fileDesc_google_protobuf_unittest, 106, 1);
...
export const EnumsForBenchmark_SparseDesc: TypedDescEnum<EnumsForBenchmark_Sparse> = enumDesc(fileDesc_google_protobuf_unittest, 106, 2);
...
export const TestMessageWithManyRepeatedPtrFieldsDesc: TypedDescMessage<TestMessageWithManyRepeatedPtrFields> = messageDesc(fileDesc_google_protobuf_unittest, 107);
...
export const ForeignEnumDesc: TypedDescEnum<ForeignEnum> = enumDesc(fileDesc_google_protobuf_unittest, 0);
...
export const TestReservedEnumFieldsDesc: TypedDescEnum<TestReservedEnumFields> = enumDesc(fileDesc_google_protobuf_unittest, 1);
...
export const TestEnumWithDupValueDesc: TypedDescEnum<TestEnumWithDupValue> = enumDesc(fileDesc_google_protobuf_unittest, 2);
...
export const TestSparseEnumDesc: TypedDescEnum<TestSparseEnum> = enumDesc(fileDesc_google_protobuf_unittest, 3);
...
export const VeryLargeEnumDesc: TypedDescEnum<VeryLargeEnum> = enumDesc(fileDesc_google_protobuf_unittest, 4);
 ...
 */
export const optional_int32_extension: TypedDescExtension<TestAllExtensions, number> = extDesc(fileDesc_google_protobuf_unittest, 0);

/**
 * @generated from extension: optional int64 optional_int64_extension = 2;
 */
export const optional_int64_extension: TypedDescExtension<TestAllExtensions, bigint> = extDesc(fileDesc_google_protobuf_unittest, 1);

/**
 * @generated from extension: optional uint32 optional_uint32_extension = 3;
 */
export const optional_uint32_extension: TypedDescExtension<TestAllExtensions, number> = extDesc(fileDesc_google_protobuf_unittest, 2);

/**
 * @generated from extension: optional uint64 optional_uint64_extension = 4;
 */
export const optional_uint64_extension: TypedDescExtension<TestAllExtensions, bigint> = extDesc(fileDesc_google_protobuf_unittest, 3);

/**
 * @generated from extension: optional sint32 optional_sint32_extension = 5;
 */
export const optional_sint32_extension: TypedDescExtension<TestAllExtensions, number> = extDesc(fileDesc_google_protobuf_unittest, 4);

/**
 * @generated from extension: optional sint64 optional_sint64_extension = 6;
 */
export const optional_sint64_extension: TypedDescExtension<TestAllExtensions, bigint> = extDesc(fileDesc_google_protobuf_unittest, 5);

/**
 * @generated from extension: optional fixed32 optional_fixed32_extension = 7;
 */
export const optional_fixed32_extension: TypedDescExtension<TestAllExtensions, number> = extDesc(fileDesc_google_protobuf_unittest, 6);

/**
 * @generated from extension: optional fixed64 optional_fixed64_extension = 8;
 */
export const optional_fixed64_extension: TypedDescExtension<TestAllExtensions, bigint> = extDesc(fileDesc_google_protobuf_unittest, 7);

/**
 * @generated from extension: optional sfixed32 optional_sfixed32_extension = 9;
 */
export const optional_sfixed32_extension: TypedDescExtension<TestAllExtensions, number> = extDesc(fileDesc_google_protobuf_unittest, 8);

/**
 * @generated from extension: optional sfixed64 optional_sfixed64_extension = 10;
 */
export const optional_sfixed64_extension: TypedDescExtension<TestAllExtensions, bigint> = extDesc(fileDesc_google_protobuf_unittest, 9);

/**
 * @generated from extension: optional float optional_float_extension = 11;
 */
export const optional_float_extension: TypedDescExtension<TestAllExtensions, number> = extDesc(fileDesc_google_protobuf_unittest, 10);

/**
 * @generated from extension: optional double optional_double_extension = 12;
 */
export const optional_double_extension: TypedDescExtension<TestAllExtensions, number> = extDesc(fileDesc_google_protobuf_unittest, 11);

/**
 * @generated from extension: optional bool optional_bool_extension = 13;
 */
export const optional_bool_extension: TypedDescExtension<TestAllExtensions, boolean> = extDesc(fileDesc_google_protobuf_unittest, 12);

/**
 * @generated from extension: optional string optional_string_extension = 14;
 */
export const optional_string_extension: TypedDescExtension<TestAllExtensions, string> = extDesc(fileDesc_google_protobuf_unittest, 13);

/**
 * @generated from extension: optional bytes optional_bytes_extension = 15;
 */
export const optional_bytes_extension: TypedDescExtension<TestAllExtensions, Uint8Array> = extDesc(fileDesc_google_protobuf_unittest, 14);

/**
 * @generated from extension: optional protobuf_unittest.OptionalGroup_extension optionalgroup_extension = 16;
 */
export const optionalgroup_extension: TypedDescExtension<TestAllExtensions, OptionalGroup_extension> = extDesc(fileDesc_google_protobuf_unittest, 15);

/**
 * @generated from extension: optional protobuf_unittest.TestAllTypes.NestedMessage optional_nested_message_extension = 18;
 */
export const optional_nested_message_extension: TypedDescExtension<TestAllExtensions, TestAllTypes_NestedMessage> = extDesc(fileDesc_google_protobuf_unittest, 16);

/**
 * @generated from extension: optional protobuf_unittest.ForeignMessage optional_foreign_message_extension = 19;
 */
export const optional_foreign_message_extension: TypedDescExtension<TestAllExtensions, ForeignMessage> = extDesc(fileDesc_google_protobuf_unittest, 17);

/**
 * @generated from extension: optional protobuf_unittest_import.ImportMessage optional_import_message_extension = 20;
 */
export const optional_import_message_extension: TypedDescExtension<TestAllExtensions, ImportMessage> = extDesc(fileDesc_google_protobuf_unittest, 18);

/**
 * @generated from extension: optional protobuf_unittest.TestAllTypes.NestedEnum optional_nested_enum_extension = 21;
 */
export const optional_nested_enum_extension: TypedDescExtension<TestAllExtensions, TestAllTypes_NestedEnum> = extDesc(fileDesc_google_protobuf_unittest, 19);

/**
 * @generated from extension: optional protobuf_unittest.ForeignEnum optional_foreign_enum_extension = 22;
 */
export const optional_foreign_enum_extension: TypedDescExtension<TestAllExtensions, ForeignEnum> = extDesc(fileDesc_google_protobuf_unittest, 20);

/**
 * @generated from extension: optional protobuf_unittest_import.ImportEnum optional_import_enum_extension = 23;
 */
export const optional_import_enum_extension: TypedDescExtension<TestAllExtensions, ImportEnum> = extDesc(fileDesc_google_protobuf_unittest, 21);

/**
 * @generated from extension: optional string optional_string_piece_extension = 24;
 */
export const optional_string_piece_extension: TypedDescExtension<TestAllExtensions, string> = extDesc(fileDesc_google_protobuf_unittest, 22);
 ...
 */
export const optional_cord_extension: TypedDescExtension<TestAllExtensions, string> = extDesc(fileDesc_google_protobuf_unittest, 23);
 ...
 */
export const optional_public_import_message_extension: TypedDescExtension<TestAllExtensions, PublicImportMessage> = extDesc(fileDesc_google_protobuf_unittest, 24);

/**
 * @generated from extension: optional protobuf_unittest.TestAllTypes.NestedMessage optional_lazy_message_extension = 27;
 */
export const optional_lazy_message_extension: TypedDescExtension<TestAllExtensions, TestAllTypes_NestedMessage> = extDesc(fileDesc_google_protobuf_unittest, 25);
 ...
 */
export const optional_unverified_lazy_message_extension: TypedDescExtension<TestAllExtensions, TestAllTypes_NestedMessage> = extDesc(fileDesc_google_protobuf_unittest, 26);
 ...
 */
export const repeated_int32_extension: TypedDescExtension<TestAllExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 27);

/**
 * @generated from extension: repeated int64 repeated_int64_extension = 32;
 */
export const repeated_int64_extension: TypedDescExtension<TestAllExtensions, bigint[]> = extDesc(fileDesc_google_protobuf_unittest, 28);

/**
 * @generated from extension: repeated uint32 repeated_uint32_extension = 33;
 */
export const repeated_uint32_extension: TypedDescExtension<TestAllExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 29);

/**
 * @generated from extension: repeated uint64 repeated_uint64_extension = 34;
 */
export const repeated_uint64_extension: TypedDescExtension<TestAllExtensions, bigint[]> = extDesc(fileDesc_google_protobuf_unittest, 30);

/**
 * @generated from extension: repeated sint32 repeated_sint32_extension = 35;
 */
export const repeated_sint32_extension: TypedDescExtension<TestAllExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 31);

/**
 * @generated from extension: repeated sint64 repeated_sint64_extension = 36;
 */
export const repeated_sint64_extension: TypedDescExtension<TestAllExtensions, bigint[]> = extDesc(fileDesc_google_protobuf_unittest, 32);

/**
 * @generated from extension: repeated fixed32 repeated_fixed32_extension = 37;
 */
export const repeated_fixed32_extension: TypedDescExtension<TestAllExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 33);

/**
 * @generated from extension: repeated fixed64 repeated_fixed64_extension = 38;
 */
export const repeated_fixed64_extension: TypedDescExtension<TestAllExtensions, bigint[]> = extDesc(fileDesc_google_protobuf_unittest, 34);

/**
 * @generated from extension: repeated sfixed32 repeated_sfixed32_extension = 39;
 */
export const repeated_sfixed32_extension: TypedDescExtension<TestAllExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 35);

/**
 * @generated from extension: repeated sfixed64 repeated_sfixed64_extension = 40;
 */
export const repeated_sfixed64_extension: TypedDescExtension<TestAllExtensions, bigint[]> = extDesc(fileDesc_google_protobuf_unittest, 36);

/**
 * @generated from extension: repeated float repeated_float_extension = 41;
 */
export const repeated_float_extension: TypedDescExtension<TestAllExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 37);

/**
 * @generated from extension: repeated double repeated_double_extension = 42;
 */
export const repeated_double_extension: TypedDescExtension<TestAllExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 38);

/**
 * @generated from extension: repeated bool repeated_bool_extension = 43;
 */
export const repeated_bool_extension: TypedDescExtension<TestAllExtensions, boolean[]> = extDesc(fileDesc_google_protobuf_unittest, 39);

/**
 * @generated from extension: repeated string repeated_string_extension = 44;
 */
export const repeated_string_extension: TypedDescExtension<TestAllExtensions, string[]> = extDesc(fileDesc_google_protobuf_unittest, 40);

/**
 * @generated from extension: repeated bytes repeated_bytes_extension = 45;
 */
export const repeated_bytes_extension: TypedDescExtension<TestAllExtensions, Uint8Array[]> = extDesc(fileDesc_google_protobuf_unittest, 41);

/**
 * @generated from extension: repeated protobuf_unittest.RepeatedGroup_extension repeatedgroup_extension = 46;
 */
export const repeatedgroup_extension: TypedDescExtension<TestAllExtensions, RepeatedGroup_extension[]> = extDesc(fileDesc_google_protobuf_unittest, 42);

/**
 * @generated from extension: repeated protobuf_unittest.TestAllTypes.NestedMessage repeated_nested_message_extension = 48;
 */
export const repeated_nested_message_extension: TypedDescExtension<TestAllExtensions, TestAllTypes_NestedMessage[]> = extDesc(fileDesc_google_protobuf_unittest, 43);

/**
 * @generated from extension: repeated protobuf_unittest.ForeignMessage repeated_foreign_message_extension = 49;
 */
export const repeated_foreign_message_extension: TypedDescExtension<TestAllExtensions, ForeignMessage[]> = extDesc(fileDesc_google_protobuf_unittest, 44);

/**
 * @generated from extension: repeated protobuf_unittest_import.ImportMessage repeated_import_message_extension = 50;
 */
export const repeated_import_message_extension: TypedDescExtension<TestAllExtensions, ImportMessage[]> = extDesc(fileDesc_google_protobuf_unittest, 45);

/**
 * @generated from extension: repeated protobuf_unittest.TestAllTypes.NestedEnum repeated_nested_enum_extension = 51;
 */
export const repeated_nested_enum_extension: TypedDescExtension<TestAllExtensions, TestAllTypes_NestedEnum[]> = extDesc(fileDesc_google_protobuf_unittest, 46);

/**
 * @generated from extension: repeated protobuf_unittest.ForeignEnum repeated_foreign_enum_extension = 52;
 */
export const repeated_foreign_enum_extension: TypedDescExtension<TestAllExtensions, ForeignEnum[]> = extDesc(fileDesc_google_protobuf_unittest, 47);

/**
 * @generated from extension: repeated protobuf_unittest_import.ImportEnum repeated_import_enum_extension = 53;
 */
export const repeated_import_enum_extension: TypedDescExtension<TestAllExtensions, ImportEnum[]> = extDesc(fileDesc_google_protobuf_unittest, 48);

/**
 * @generated from extension: repeated string repeated_string_piece_extension = 54;
 */
export const repeated_string_piece_extension: TypedDescExtension<TestAllExtensions, string[]> = extDesc(fileDesc_google_protobuf_unittest, 49);
 ...
 */
export const repeated_cord_extension: TypedDescExtension<TestAllExtensions, string[]> = extDesc(fileDesc_google_protobuf_unittest, 50);

/**
 * @generated from extension: repeated protobuf_unittest.TestAllTypes.NestedMessage repeated_lazy_message_extension = 57;
 */
export const repeated_lazy_message_extension: TypedDescExtension<TestAllExtensions, TestAllTypes_NestedMessage[]> = extDesc(fileDesc_google_protobuf_unittest, 51);
 ...
 */
export const default_int32_extension: TypedDescExtension<TestAllExtensions, number> = extDesc(fileDesc_google_protobuf_unittest, 52);

/**
 * @generated from extension: optional int64 default_int64_extension = 62 [default = 42];
 */
export const default_int64_extension: TypedDescExtension<TestAllExtensions, bigint> = extDesc(fileDesc_google_protobuf_unittest, 53);

/**
 * @generated from extension: optional uint32 default_uint32_extension = 63 [default = 43];
 */
export const default_uint32_extension: TypedDescExtension<TestAllExtensions, number> = extDesc(fileDesc_google_protobuf_unittest, 54);

/**
 * @generated from extension: optional uint64 default_uint64_extension = 64 [default = 44];
 */
export const default_uint64_extension: TypedDescExtension<TestAllExtensions, bigint> = extDesc(fileDesc_google_protobuf_unittest, 55);

/**
 * @generated from extension: optional sint32 default_sint32_extension = 65 [default = -45];
 */
export const default_sint32_extension: TypedDescExtension<TestAllExtensions, number> = extDesc(fileDesc_google_protobuf_unittest, 56);

/**
 * @generated from extension: optional sint64 default_sint64_extension = 66 [default = 46];
 */
export const default_sint64_extension: TypedDescExtension<TestAllExtensions, bigint> = extDesc(fileDesc_google_protobuf_unittest, 57);

/**
 * @generated from extension: optional fixed32 default_fixed32_extension = 67 [default = 47];
 */
export const default_fixed32_extension: TypedDescExtension<TestAllExtensions, number> = extDesc(fileDesc_google_protobuf_unittest, 58);

/**
 * @generated from extension: optional fixed64 default_fixed64_extension = 68 [default = 48];
 */
export const default_fixed64_extension: TypedDescExtension<TestAllExtensions, bigint> = extDesc(fileDesc_google_protobuf_unittest, 59);

/**
 * @generated from extension: optional sfixed32 default_sfixed32_extension = 69 [default = 49];
 */
export const default_sfixed32_extension: TypedDescExtension<TestAllExtensions, number> = extDesc(fileDesc_google_protobuf_unittest, 60);

/**
 * @generated from extension: optional sfixed64 default_sfixed64_extension = 70 [default = -50];
 */
export const default_sfixed64_extension: TypedDescExtension<TestAllExtensions, bigint> = extDesc(fileDesc_google_protobuf_unittest, 61);

/**
 * @generated from extension: optional float default_float_extension = 71 [default = 51.5];
 */
export const default_float_extension: TypedDescExtension<TestAllExtensions, number> = extDesc(fileDesc_google_protobuf_unittest, 62);

/**
 * @generated from extension: optional double default_double_extension = 72 [default = 52000];
 */
export const default_double_extension: TypedDescExtension<TestAllExtensions, number> = extDesc(fileDesc_google_protobuf_unittest, 63);

/**
 * @generated from extension: optional bool default_bool_extension = 73 [default = true];
 */
export const default_bool_extension: TypedDescExtension<TestAllExtensions, boolean> = extDesc(fileDesc_google_protobuf_unittest, 64);

/**
 * @generated from extension: optional string default_string_extension = 74 [default = "hello"];
 */
export const default_string_extension: TypedDescExtension<TestAllExtensions, string> = extDesc(fileDesc_google_protobuf_unittest, 65);

/**
 * @generated from extension: optional bytes default_bytes_extension = 75 [default = "world"];
 */
export const default_bytes_extension: TypedDescExtension<TestAllExtensions, Uint8Array> = extDesc(fileDesc_google_protobuf_unittest, 66);

/**
 * @generated from extension: optional protobuf_unittest.TestAllTypes.NestedEnum default_nested_enum_extension = 81 [default = BAR];
 */
export const default_nested_enum_extension: TypedDescExtension<TestAllExtensions, TestAllTypes_NestedEnum> = extDesc(fileDesc_google_protobuf_unittest, 67);

/**
 * @generated from extension: optional protobuf_unittest.ForeignEnum default_foreign_enum_extension = 82 [default = FOREIGN_BAR];
 */
export const default_foreign_enum_extension: TypedDescExtension<TestAllExtensions, ForeignEnum> = extDesc(fileDesc_google_protobuf_unittest, 68);
 ...
 */
export const default_import_enum_extension: TypedDescExtension<TestAllExtensions, ImportEnum> = extDesc(fileDesc_google_protobuf_unittest, 69);

/**
 * @generated from extension: optional string default_string_piece_extension = 84 [default = "abc"];
 */
export const default_string_piece_extension: TypedDescExtension<TestAllExtensions, string> = extDesc(fileDesc_google_protobuf_unittest, 70);
 ...
 */
export const default_cord_extension: TypedDescExtension<TestAllExtensions, string> = extDesc(fileDesc_google_protobuf_unittest, 71);
 ...
 */
export const oneof_uint32_extension: TypedDescExtension<TestAllExtensions, number> = extDesc(fileDesc_google_protobuf_unittest, 72);

/**
 * @generated from extension: optional protobuf_unittest.TestAllTypes.NestedMessage oneof_nested_message_extension = 112;
 */
export const oneof_nested_message_extension: TypedDescExtension<TestAllExtensions, TestAllTypes_NestedMessage> = extDesc(fileDesc_google_protobuf_unittest, 73);

/**
 * @generated from extension: optional string oneof_string_extension = 113;
 */
export const oneof_string_extension: TypedDescExtension<TestAllExtensions, string> = extDesc(fileDesc_google_protobuf_unittest, 74);

/**
 * @generated from extension: optional bytes oneof_bytes_extension = 114;
 */
export const oneof_bytes_extension: TypedDescExtension<TestAllExtensions, Uint8Array> = extDesc(fileDesc_google_protobuf_unittest, 75);

/**
 * @generated from extension: optional string my_extension_string = 50;
 */
export const my_extension_string: TypedDescExtension<TestFieldOrderings, string> = extDesc(fileDesc_google_protobuf_unittest, 76);

/**
 * @generated from extension: optional int32 my_extension_int = 5;
 */
export const my_extension_int: TypedDescExtension<TestFieldOrderings, number> = extDesc(fileDesc_google_protobuf_unittest, 77);

/**
 * @generated from extension: repeated int32 packed_int32_extension = 90 [packed = true];
 */
export const packed_int32_extension: TypedDescExtension<TestPackedExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 78);

/**
 * @generated from extension: repeated int64 packed_int64_extension = 91 [packed = true];
 */
export const packed_int64_extension: TypedDescExtension<TestPackedExtensions, bigint[]> = extDesc(fileDesc_google_protobuf_unittest, 79);

/**
 * @generated from extension: repeated uint32 packed_uint32_extension = 92 [packed = true];
 */
export const packed_uint32_extension: TypedDescExtension<TestPackedExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 80);

/**
 * @generated from extension: repeated uint64 packed_uint64_extension = 93 [packed = true];
 */
export const packed_uint64_extension: TypedDescExtension<TestPackedExtensions, bigint[]> = extDesc(fileDesc_google_protobuf_unittest, 81);

/**
 * @generated from extension: repeated sint32 packed_sint32_extension = 94 [packed = true];
 */
export const packed_sint32_extension: TypedDescExtension<TestPackedExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 82);

/**
 * @generated from extension: repeated sint64 packed_sint64_extension = 95 [packed = true];
 */
export const packed_sint64_extension: TypedDescExtension<TestPackedExtensions, bigint[]> = extDesc(fileDesc_google_protobuf_unittest, 83);

/**
 * @generated from extension: repeated fixed32 packed_fixed32_extension = 96 [packed = true];
 */
export const packed_fixed32_extension: TypedDescExtension<TestPackedExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 84);

/**
 * @generated from extension: repeated fixed64 packed_fixed64_extension = 97 [packed = true];
 */
export const packed_fixed64_extension: TypedDescExtension<TestPackedExtensions, bigint[]> = extDesc(fileDesc_google_protobuf_unittest, 85);

/**
 * @generated from extension: repeated sfixed32 packed_sfixed32_extension = 98 [packed = true];
 */
export const packed_sfixed32_extension: TypedDescExtension<TestPackedExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 86);

/**
 * @generated from extension: repeated sfixed64 packed_sfixed64_extension = 99 [packed = true];
 */
export const packed_sfixed64_extension: TypedDescExtension<TestPackedExtensions, bigint[]> = extDesc(fileDesc_google_protobuf_unittest, 87);

/**
 * @generated from extension: repeated float packed_float_extension = 100 [packed = true];
 */
export const packed_float_extension: TypedDescExtension<TestPackedExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 88);

/**
 * @generated from extension: repeated double packed_double_extension = 101 [packed = true];
 */
export const packed_double_extension: TypedDescExtension<TestPackedExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 89);

/**
 * @generated from extension: repeated bool packed_bool_extension = 102 [packed = true];
 */
export const packed_bool_extension: TypedDescExtension<TestPackedExtensions, boolean[]> = extDesc(fileDesc_google_protobuf_unittest, 90);

/**
 * @generated from extension: repeated protobuf_unittest.ForeignEnum packed_enum_extension = 103 [packed = true];
 */
export const packed_enum_extension: TypedDescExtension<TestPackedExtensions, ForeignEnum[]> = extDesc(fileDesc_google_protobuf_unittest, 91);

/**
 * @generated from extension: repeated int32 unpacked_int32_extension = 90 [packed = false];
 */
export const unpacked_int32_extension: TypedDescExtension<TestUnpackedExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 92);

/**
 * @generated from extension: repeated int64 unpacked_int64_extension = 91 [packed = false];
 */
export const unpacked_int64_extension: TypedDescExtension<TestUnpackedExtensions, bigint[]> = extDesc(fileDesc_google_protobuf_unittest, 93);

/**
 * @generated from extension: repeated uint32 unpacked_uint32_extension = 92 [packed = false];
 */
export const unpacked_uint32_extension: TypedDescExtension<TestUnpackedExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 94);

/**
 * @generated from extension: repeated uint64 unpacked_uint64_extension = 93 [packed = false];
 */
export const unpacked_uint64_extension: TypedDescExtension<TestUnpackedExtensions, bigint[]> = extDesc(fileDesc_google_protobuf_unittest, 95);

/**
 * @generated from extension: repeated sint32 unpacked_sint32_extension = 94 [packed = false];
 */
export const unpacked_sint32_extension: TypedDescExtension<TestUnpackedExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 96);

/**
 * @generated from extension: repeated sint64 unpacked_sint64_extension = 95 [packed = false];
 */
export const unpacked_sint64_extension: TypedDescExtension<TestUnpackedExtensions, bigint[]> = extDesc(fileDesc_google_protobuf_unittest, 97);

/**
 * @generated from extension: repeated fixed32 unpacked_fixed32_extension = 96 [packed = false];
 */
export const unpacked_fixed32_extension: TypedDescExtension<TestUnpackedExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 98);

/**
 * @generated from extension: repeated fixed64 unpacked_fixed64_extension = 97 [packed = false];
 */
export const unpacked_fixed64_extension: TypedDescExtension<TestUnpackedExtensions, bigint[]> = extDesc(fileDesc_google_protobuf_unittest, 99);

/**
 * @generated from extension: repeated sfixed32 unpacked_sfixed32_extension = 98 [packed = false];
 */
export const unpacked_sfixed32_extension: TypedDescExtension<TestUnpackedExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 100);

/**
 * @generated from extension: repeated sfixed64 unpacked_sfixed64_extension = 99 [packed = false];
 */
export const unpacked_sfixed64_extension: TypedDescExtension<TestUnpackedExtensions, bigint[]> = extDesc(fileDesc_google_protobuf_unittest, 101);

/**
 * @generated from extension: repeated float unpacked_float_extension = 100 [packed = false];
 */
export const unpacked_float_extension: TypedDescExtension<TestUnpackedExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 102);

/**
 * @generated from extension: repeated double unpacked_double_extension = 101 [packed = false];
 */
export const unpacked_double_extension: TypedDescExtension<TestUnpackedExtensions, number[]> = extDesc(fileDesc_google_protobuf_unittest, 103);

/**
 * @generated from extension: repeated bool unpacked_bool_extension = 102 [packed = false];
 */
export const unpacked_bool_extension: TypedDescExtension<TestUnpackedExtensions, boolean[]> = extDesc(fileDesc_google_protobuf_unittest, 104);

/**
 * @generated from extension: repeated protobuf_unittest.ForeignEnum unpacked_enum_extension = 103 [packed = false];
 */
export const unpacked_enum_extension: TypedDescExtension<TestUnpackedExtensions, ForeignEnum[]> = extDesc(fileDesc_google_protobuf_unittest, 105);

/**
 * @generated from extension: optional protobuf_unittest.TestAllTypes test_all_types = 536860000;
 */
export const test_all_types: TypedDescExtension<TestHugeFieldNumbers, TestAllTypes> = extDesc(fileDesc_google_protobuf_unittest, 106);

/**
 * @generated from extension: optional int32 test_extension_inside_table_extension = 5;
 */
export const test_extension_inside_table_extension: TypedDescExtension<TestExtensionInsideTable, number> = extDesc(fileDesc_google_protobuf_unittest, 107);

/**
 * @generated from extension: optional protobuf_unittest.TestNestedGroupExtensionInnerExtension inner = 3;
 */
export const inner: TypedDescExtension<TestNestedGroupExtensionOuter_Layer1OptionalGroup_Layer2RepeatedGroup, TestNestedGroupExtensionInnerExtension> = extDesc(fileDesc_google_protobuf_unittest, 108);
