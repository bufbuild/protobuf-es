...
export const TestWellKnownTypesDesc: TypedDescMessage<TestWellKnownTypes> = messageDesc(fileDesc_google_protobuf_unittest_well_known_types, 0);
...
export const RepeatedWellKnownTypesDesc: TypedDescMessage<RepeatedWellKnownTypes> = messageDesc(fileDesc_google_protobuf_unittest_well_known_types, 1);
...
export const OneofWellKnownTypesDesc: TypedDescMessage<OneofWellKnownTypes> = messageDesc(fileDesc_google_protobuf_unittest_well_known_types, 2);
...
export const MapWellKnownTypesDesc: TypedDescMessage<MapWellKnownTypes> = messageDesc(fileDesc_google_protobuf_unittest_well_known_types, 3);
