 ...
 */
export class JavaFeatures extends Message<JavaFeatures> {
  /**
  ...
  static equals(a: JavaFeatures | PlainMessage<JavaFeatures> | undefined, b: JavaFeatures | PlainMessage<JavaFeatures> | undefined): boolean {
    return proto2.util.equals(JavaFeatures, a, b);
  }
}
...
// Retrieve enum metadata with: proto2.getEnumType(JavaFeatures_Utf8Validation)
proto2.util.setEnumType(JavaFeatures_Utf8Validation, "pb.JavaFeatures.Utf8Validation", [
 ...
 */
export const java = proto2.makeExtension<FeatureSet, JavaFeatures>(
  "pb.java", 
  FeatureSet, 
