...
export const TestEnormousDescriptorDesc: TypedDescMessage<TestEnormousDescriptor> = messageDesc(fileDesc_google_protobuf_unittest_enormous_descriptor, 0);
