...
// Use `create(TestMessageWithCustomOptionsDesc)` to create a new TestMessageWithCustomOptions.
export const TestMessageWithCustomOptionsDesc: TypedDescMessage<TestMessageWithCustomOptions> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 0);
...
export const TestMessageWithCustomOptions_AnEnumDesc: TypedDescEnum<TestMessageWithCustomOptions_AnEnum> = enumDesc(fileDesc_google_protobuf_unittest_custom_options, 0, 0);
...
// Use `create(CustomOptionFooRequestDesc)` to create a new CustomOptionFooRequest.
export const CustomOptionFooRequestDesc: TypedDescMessage<CustomOptionFooRequest> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 1);
...
// Use `create(CustomOptionFooResponseDesc)` to create a new CustomOptionFooResponse.
export const CustomOptionFooResponseDesc: TypedDescMessage<CustomOptionFooResponse> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 2);
...
// Use `create(CustomOptionFooClientMessageDesc)` to create a new CustomOptionFooClientMessage.
export const CustomOptionFooClientMessageDesc: TypedDescMessage<CustomOptionFooClientMessage> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 3);
...
// Use `create(CustomOptionFooServerMessageDesc)` to create a new CustomOptionFooServerMessage.
export const CustomOptionFooServerMessageDesc: TypedDescMessage<CustomOptionFooServerMessage> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 4);
...
// Use `create(DummyMessageContainingEnumDesc)` to create a new DummyMessageContainingEnum.
export const DummyMessageContainingEnumDesc: TypedDescMessage<DummyMessageContainingEnum> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 5);
...
export const DummyMessageContainingEnum_TestEnumTypeDesc: TypedDescEnum<DummyMessageContainingEnum_TestEnumType> = enumDesc(fileDesc_google_protobuf_unittest_custom_options, 5, 0);
...
// Use `create(DummyMessageInvalidAsOptionTypeDesc)` to create a new DummyMessageInvalidAsOptionType.
export const DummyMessageInvalidAsOptionTypeDesc: TypedDescMessage<DummyMessageInvalidAsOptionType> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 6);
...
// Use `create(CustomOptionMinIntegerValuesDesc)` to create a new CustomOptionMinIntegerValues.
export const CustomOptionMinIntegerValuesDesc: TypedDescMessage<CustomOptionMinIntegerValues> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 7);
...
// Use `create(CustomOptionMaxIntegerValuesDesc)` to create a new CustomOptionMaxIntegerValues.
export const CustomOptionMaxIntegerValuesDesc: TypedDescMessage<CustomOptionMaxIntegerValues> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 8);
...
// Use `create(CustomOptionOtherValuesDesc)` to create a new CustomOptionOtherValues.
export const CustomOptionOtherValuesDesc: TypedDescMessage<CustomOptionOtherValues> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 9);
...
// Use `create(SettingRealsFromPositiveIntsDesc)` to create a new SettingRealsFromPositiveInts.
export const SettingRealsFromPositiveIntsDesc: TypedDescMessage<SettingRealsFromPositiveInts> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 10);
...
// Use `create(SettingRealsFromNegativeIntsDesc)` to create a new SettingRealsFromNegativeInts.
export const SettingRealsFromNegativeIntsDesc: TypedDescMessage<SettingRealsFromNegativeInts> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 11);
...
// Use `create(ComplexOptionType1Desc)` to create a new ComplexOptionType1.
export const ComplexOptionType1Desc: TypedDescMessage<ComplexOptionType1> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 12);
...
// Use `create(ComplexOptionType2Desc)` to create a new ComplexOptionType2.
export const ComplexOptionType2Desc: TypedDescMessage<ComplexOptionType2> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 13);
...
// Use `create(ComplexOptionType2_ComplexOptionType4Desc)` to create a new ComplexOptionType2_ComplexOptionType4.
export const ComplexOptionType2_ComplexOptionType4Desc: TypedDescMessage<ComplexOptionType2_ComplexOptionType4> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 13, 0);

/**
 * @generated from extension: optional protobuf_unittest.ComplexOptionType2.ComplexOptionType4 complex_opt4 = 7633546;
 */
export const ComplexOptionType2_ComplexOptionType4_complex_opt4: TypedDescExtension<MessageOptions, ComplexOptionType2_ComplexOptionType4> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 13, 0, 0);
...
// Use `create(ComplexOptionType3Desc)` to create a new ComplexOptionType3.
export const ComplexOptionType3Desc: TypedDescMessage<ComplexOptionType3> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 14);
...
// Use `create(ComplexOptionType3_ComplexOptionType5Desc)` to create a new ComplexOptionType3_ComplexOptionType5.
export const ComplexOptionType3_ComplexOptionType5Desc: TypedDescMessage<ComplexOptionType3_ComplexOptionType5> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 14, 0);
...
// Use `create(ComplexOpt6Desc)` to create a new ComplexOpt6.
export const ComplexOpt6Desc: TypedDescMessage<ComplexOpt6> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 15);
...
// Use `create(VariousComplexOptionsDesc)` to create a new VariousComplexOptions.
export const VariousComplexOptionsDesc: TypedDescMessage<VariousComplexOptions> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 16);
...
// Use `create(AggregateMessageSetDesc)` to create a new AggregateMessageSet.
export const AggregateMessageSetDesc: TypedDescMessage<AggregateMessageSet> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 17);
...
// Use `create(AggregateMessageSetElementDesc)` to create a new AggregateMessageSetElement.
export const AggregateMessageSetElementDesc: TypedDescMessage<AggregateMessageSetElement> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 18);

/**
 * @generated from extension: optional protobuf_unittest.AggregateMessageSetElement message_set_extension = 15447542;
 */
export const AggregateMessageSetElement_message_set_extension: TypedDescExtension<AggregateMessageSet, AggregateMessageSetElement> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 18, 0);
...
// Use `create(AggregateDesc)` to create a new Aggregate.
export const AggregateDesc: TypedDescMessage<Aggregate> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 19);

/**
 * @generated from extension: optional protobuf_unittest.Aggregate nested = 15476903;
 */
export const Aggregate_nested: TypedDescExtension<FileOptions, Aggregate> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 19, 0);
...
// Use `create(AggregateMessageDesc)` to create a new AggregateMessage.
export const AggregateMessageDesc: TypedDescMessage<AggregateMessage> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 20);
...
// Use `create(NestedOptionTypeDesc)` to create a new NestedOptionType.
export const NestedOptionTypeDesc: TypedDescMessage<NestedOptionType> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 21);
...
// Use `create(NestedOptionType_NestedMessageDesc)` to create a new NestedOptionType_NestedMessage.
export const NestedOptionType_NestedMessageDesc: TypedDescMessage<NestedOptionType_NestedMessage> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 21, 0);
...
export const NestedOptionType_NestedEnumDesc: TypedDescEnum<NestedOptionType_NestedEnum> = enumDesc(fileDesc_google_protobuf_unittest_custom_options, 21, 0);

/**
 * @generated from extension: optional int32 nested_extension = 7912573;
 */
export const NestedOptionType_nested_extension: TypedDescExtension<FileOptions, number> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 21, 0);
...
// Use `create(OldOptionTypeDesc)` to create a new OldOptionType.
export const OldOptionTypeDesc: TypedDescMessage<OldOptionType> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 22);
...
export const OldOptionType_TestEnumDesc: TypedDescEnum<OldOptionType_TestEnum> = enumDesc(fileDesc_google_protobuf_unittest_custom_options, 22, 0);
...
// Use `create(NewOptionTypeDesc)` to create a new NewOptionType.
export const NewOptionTypeDesc: TypedDescMessage<NewOptionType> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 23);
...
export const NewOptionType_TestEnumDesc: TypedDescEnum<NewOptionType_TestEnum> = enumDesc(fileDesc_google_protobuf_unittest_custom_options, 23, 0);
...
// Use `create(TestMessageWithRequiredEnumOptionDesc)` to create a new TestMessageWithRequiredEnumOption.
export const TestMessageWithRequiredEnumOptionDesc: TypedDescMessage<TestMessageWithRequiredEnumOption> = messageDesc(fileDesc_google_protobuf_unittest_custom_options, 24);
...
export const MethodOpt1Desc: TypedDescEnum<MethodOpt1> = enumDesc(fileDesc_google_protobuf_unittest_custom_options, 0);
...
export const AggregateEnumDesc: TypedDescEnum<AggregateEnum> = enumDesc(fileDesc_google_protobuf_unittest_custom_options, 1);

/**
 * @generated from service protobuf_unittest.TestServiceWithCustomOptions
 */
export const TestServiceWithCustomOptions: TypedDescService<{
  /**
...
> = serviceDesc(fileDesc_google_protobuf_unittest_custom_options, 0);

/**
 * @generated from service protobuf_unittest.AggregateService
 */
export const AggregateService: TypedDescService<{
  /**
...
> = serviceDesc(fileDesc_google_protobuf_unittest_custom_options, 1);

/**
 * @generated from extension: optional uint64 file_opt1 = 7736974;
 */
export const file_opt1: TypedDescExtension<FileOptions, bigint> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 0);

/**
 * @generated from extension: optional int32 message_opt1 = 7739036;
 */
export const message_opt1: TypedDescExtension<MessageOptions, number> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 1);

/**
 * @generated from extension: optional fixed64 field_opt1 = 7740936;
 */
export const field_opt1: TypedDescExtension<FieldOptions, bigint> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 2);
 ...
 */
export const field_opt2: TypedDescExtension<FieldOptions, number> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 3);

/**
 * @generated from extension: optional int32 oneof_opt1 = 7740111;
 */
export const oneof_opt1: TypedDescExtension<OneofOptions, number> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 4);

/**
 * @generated from extension: optional sfixed32 enum_opt1 = 7753576;
 */
export const enum_opt1: TypedDescExtension<EnumOptions, number> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 5);

/**
 * @generated from extension: optional int32 enum_value_opt1 = 1560678;
 */
export const enum_value_opt1: TypedDescExtension<EnumValueOptions, number> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 6);

/**
 * @generated from extension: optional sint64 service_opt1 = 7887650;
 */
export const service_opt1: TypedDescExtension<ServiceOptions, bigint> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 7);

/**
 * @generated from extension: optional protobuf_unittest.MethodOpt1 method_opt1 = 7890860;
 */
export const method_opt1: TypedDescExtension<MethodOptions, MethodOpt1> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 8);

/**
 * @generated from extension: optional bool bool_opt = 7706090;
 */
export const bool_opt: TypedDescExtension<MessageOptions, boolean> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 9);

/**
 * @generated from extension: optional int32 int32_opt = 7705709;
 */
export const int32_opt: TypedDescExtension<MessageOptions, number> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 10);

/**
 * @generated from extension: optional int64 int64_opt = 7705542;
 */
export const int64_opt: TypedDescExtension<MessageOptions, bigint> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 11);

/**
 * @generated from extension: optional uint32 uint32_opt = 7704880;
 */
export const uint32_opt: TypedDescExtension<MessageOptions, number> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 12);

/**
 * @generated from extension: optional uint64 uint64_opt = 7702367;
 */
export const uint64_opt: TypedDescExtension<MessageOptions, bigint> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 13);

/**
 * @generated from extension: optional sint32 sint32_opt = 7701568;
 */
export const sint32_opt: TypedDescExtension<MessageOptions, number> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 14);

/**
 * @generated from extension: optional sint64 sint64_opt = 7700863;
 */
export const sint64_opt: TypedDescExtension<MessageOptions, bigint> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 15);

/**
 * @generated from extension: optional fixed32 fixed32_opt = 7700307;
 */
export const fixed32_opt: TypedDescExtension<MessageOptions, number> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 16);

/**
 * @generated from extension: optional fixed64 fixed64_opt = 7700194;
 */
export const fixed64_opt: TypedDescExtension<MessageOptions, bigint> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 17);

/**
 * @generated from extension: optional sfixed32 sfixed32_opt = 7698645;
 */
export const sfixed32_opt: TypedDescExtension<MessageOptions, number> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 18);

/**
 * @generated from extension: optional sfixed64 sfixed64_opt = 7685475;
 */
export const sfixed64_opt: TypedDescExtension<MessageOptions, bigint> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 19);

/**
 * @generated from extension: optional float float_opt = 7675390;
 */
export const float_opt: TypedDescExtension<MessageOptions, number> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 20);

/**
 * @generated from extension: optional double double_opt = 7673293;
 */
export const double_opt: TypedDescExtension<MessageOptions, number> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 21);

/**
 * @generated from extension: optional string string_opt = 7673285;
 */
export const string_opt: TypedDescExtension<MessageOptions, string> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 22);

/**
 * @generated from extension: optional bytes bytes_opt = 7673238;
 */
export const bytes_opt: TypedDescExtension<MessageOptions, Uint8Array> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 23);

/**
 * @generated from extension: optional protobuf_unittest.DummyMessageContainingEnum.TestEnumType enum_opt = 7673233;
 */
export const enum_opt: TypedDescExtension<MessageOptions, DummyMessageContainingEnum_TestEnumType> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 24);

/**
 * @generated from extension: optional protobuf_unittest.DummyMessageInvalidAsOptionType message_type_opt = 7665967;
 */
export const message_type_opt: TypedDescExtension<MessageOptions, DummyMessageInvalidAsOptionType> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 25);

/**
 * @generated from extension: optional int32 mooo = 7663707;
 */
export const mooo: TypedDescExtension<ComplexOptionType1, number> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 26);

/**
 * @generated from extension: optional protobuf_unittest.ComplexOptionType3 corge = 7663442;
 */
export const corge: TypedDescExtension<ComplexOptionType1, ComplexOptionType3> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 27);

/**
 * @generated from extension: optional int32 grault = 7650927;
 */
export const grault: TypedDescExtension<ComplexOptionType2, number> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 28);

/**
 * @generated from extension: optional protobuf_unittest.ComplexOptionType1 garply = 7649992;
 */
export const garply: TypedDescExtension<ComplexOptionType2, ComplexOptionType1> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 29);

/**
 * @generated from extension: optional protobuf_unittest.ComplexOptionType1 complex_opt1 = 7646756;
 */
export const complex_opt1: TypedDescExtension<MessageOptions, ComplexOptionType1> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 30);

/**
 * @generated from extension: optional protobuf_unittest.ComplexOptionType2 complex_opt2 = 7636949;
 */
export const complex_opt2: TypedDescExtension<MessageOptions, ComplexOptionType2> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 31);

/**
 * @generated from extension: optional protobuf_unittest.ComplexOptionType3 complex_opt3 = 7636463;
 */
export const complex_opt3: TypedDescExtension<MessageOptions, ComplexOptionType3> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 32);

/**
 * @generated from extension: optional protobuf_unittest.ComplexOpt6 complexopt6 = 7595468;
 */
export const complexopt6: TypedDescExtension<MessageOptions, ComplexOpt6> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 33);

/**
 * @generated from extension: optional protobuf_unittest.Aggregate fileopt = 15478479;
 */
export const fileopt: TypedDescExtension<FileOptions, Aggregate> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 34);

/**
 * @generated from extension: optional protobuf_unittest.Aggregate msgopt = 15480088;
 */
export const msgopt: TypedDescExtension<MessageOptions, Aggregate> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 35);

/**
 * @generated from extension: optional protobuf_unittest.Aggregate fieldopt = 15481374;
 */
export const fieldopt: TypedDescExtension<FieldOptions, Aggregate> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 36);

/**
 * @generated from extension: optional protobuf_unittest.Aggregate enumopt = 15483218;
 */
export const enumopt: TypedDescExtension<EnumOptions, Aggregate> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 37);

/**
 * @generated from extension: optional protobuf_unittest.Aggregate enumvalopt = 15486921;
 */
export const enumvalopt: TypedDescExtension<EnumValueOptions, Aggregate> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 38);

/**
 * @generated from extension: optional protobuf_unittest.Aggregate serviceopt = 15497145;
 */
export const serviceopt: TypedDescExtension<ServiceOptions, Aggregate> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 39);

/**
 * @generated from extension: optional protobuf_unittest.Aggregate methodopt = 15512713;
 */
export const methodopt: TypedDescExtension<MethodOptions, Aggregate> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 40);

/**
 * @generated from extension: optional protobuf_unittest.OldOptionType required_enum_opt = 106161807;
 */
export const required_enum_opt: TypedDescExtension<MessageOptions, OldOptionType> = extDesc(fileDesc_google_protobuf_unittest_custom_options, 41);
