 ...
 */
export const file_google_protobuf_map_proto2_unittest: GenDescFile = /*@__PURE__*/
 ...
 */
export const TestEnumMapSchema: GenDescMessage<TestEnumMap, TestEnumMapJson> = /*@__PURE__*/
 ...
 */
export type TestEnumMapPlusExtraJson = {
  /**
   * @generated from field: map<int32, protobuf_unittest.Proto2MapEnumPlusExtra> known_map_field = 101;
   */
 ...
 */
export const TestEnumMapPlusExtraSchema: GenDescMessage<TestEnumMapPlusExtra, TestEnumMapPlusExtraJson> = /*@__PURE__*/
 ...
 */
export type TestImportEnumMapJson = {
  /**
   * @generated from field: map<int32, protobuf_unittest_import.ImportEnumForMap> import_enum_amp = 1;
   */
 ...
 */
export const TestImportEnumMapSchema: GenDescMessage<TestImportEnumMap, TestImportEnumMapJson> = /*@__PURE__*/
 ...
 */
export const TestIntIntMapSchema: GenDescMessage<TestIntIntMap, TestIntIntMapJson> = /*@__PURE__*/
 ...
 */
export const TestMapsSchema: GenDescMessage<TestMaps, TestMapsJson> = /*@__PURE__*/
 ...
 */
export type TestSubmessageMapsJson = {
  /**
   * @generated from field: optional protobuf_unittest.TestMaps m = 1;
   */
  m?: TestMapsJson;
 ...
 */
export const TestSubmessageMapsSchema: GenDescMessage<TestSubmessageMaps, TestSubmessageMapsJson> = /*@__PURE__*/
 ...
 */
export type TestProto2BytesMapJson = {
  /**
   * @generated from field: map<int32, bytes> map_bytes = 1;
   */
 ...
 */
export const TestProto2BytesMapSchema: GenDescMessage<TestProto2BytesMap, TestProto2BytesMapJson> = /*@__PURE__*/
 ...
 */
export type Proto2MapEnumJson = "PROTO2_MAP_ENUM_FOO" | "PROTO2_MAP_ENUM_BAR" | "PROTO2_MAP_ENUM_BAZ";

/**
 * Describes the enum protobuf_unittest.Proto2MapEnum.
 */
export const Proto2MapEnumSchema: GenDescEnum<Proto2MapEnum, Proto2MapEnumJson> = /*@__PURE__*/
 ...
 */
export type Proto2MapEnumPlusExtraJson = "E_PROTO2_MAP_ENUM_FOO" | "E_PROTO2_MAP_ENUM_BAR" | "E_PROTO2_MAP_ENUM_BAZ" | "E_PROTO2_MAP_ENUM_EXTRA";

/**
 * Describes the enum protobuf_unittest.Proto2MapEnumPlusExtra.
 */
export const Proto2MapEnumPlusExtraSchema: GenDescEnum<Proto2MapEnumPlusExtra, Proto2MapEnumPlusExtraJson> = /*@__PURE__*/
