 ...
 */
export type MessageWithOptionsJson = {
  /**
   * @generated from field: int32 field = 1;
   */
  field?: number;
 ...
 */
export const MessageWithOptionsSchema: GenDescMessage<MessageWithOptions, MessageWithOptionsJson> = /*@__PURE__*/
 ...
 */
export type EnumWithOptionsJson = "ENUM_WITH_OPTIONS_UNSPECIFIED";

/**
 * Describes the enum spec.EnumWithOptions.
 */
export const EnumWithOptionsSchema: GenDescEnum<EnumWithOptions, EnumWithOptionsJson> = /*@__PURE__*/
