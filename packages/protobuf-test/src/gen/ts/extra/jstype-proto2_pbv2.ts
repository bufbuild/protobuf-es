...
export const fileDesc_extra_jstype_proto2: DescFile = fileDesc("");
...
export const JSTypeProto2OmittedMessageDesc: TypedDescMessage<JSTypeProto2OmittedMessage> = messageDesc(fileDesc_extra_jstype_proto2, 0);
...
export const JSTypeProto2NormalMessageDesc: TypedDescMessage<JSTypeProto2NormalMessage> = messageDesc(fileDesc_extra_jstype_proto2, 1);
...
export const JSTypeProto2StringMessageDesc: TypedDescMessage<JSTypeProto2StringMessage> = messageDesc(fileDesc_extra_jstype_proto2, 2);
...
export const JSTypeProto2NumberMessageDesc: TypedDescMessage<JSTypeProto2NumberMessage> = messageDesc(fileDesc_extra_jstype_proto2, 3);
