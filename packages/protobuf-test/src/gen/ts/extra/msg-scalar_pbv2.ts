...
export const fileDesc_extra_msg_scalar: DescFile = fileDesc("");
...
export const ScalarValuesMessageDesc: TypedDescMessage<ScalarValuesMessage> = messageDesc(fileDesc_extra_msg_scalar, 0);
...
export const RepeatedScalarValuesMessageDesc: TypedDescMessage<RepeatedScalarValuesMessage> = messageDesc(fileDesc_extra_msg_scalar, 1);
