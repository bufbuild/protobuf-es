...
// @generated by protoc-gen-twirp-es v2.0.0-alpha.4 with parameter "target=ts,log_requests=true"
...
export class ElizaServiceClient {
    ...
    async say(request: SayRequest): Promise<SayResponse> {
        ...
        console.log(`POST ${this.baseUrl}/connectrpc.eliza.v1.ElizaService/Say`, request);
