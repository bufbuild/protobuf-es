...
An extension is a field defined outside of its container message. For example, we can add the field `age` to the message
`User`:
...
registry.getEnum("example.Foo"); // DescEnum | undefined
